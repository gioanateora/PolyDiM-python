    ...
    class vem:  # Proxy class that introduces typings for the *submodule* vem
        ...
        class pcc:  # Proxy class that introduces typings for the *submodule* pcc
            ...
            class VEM_PCC_2D_LocalSpace_Data:
                ...
                inertia_data: Polydim.Utilities.Inertia_Utilities.Inertia_Data
                ...
                def __init__(
                    ...
                    internal_quadrature_kl: Gedim.Quadrature.QuadratureData = Gedim.Quadrature.QuadratureData(),
                    boundary_quadrature_kl: VEM.Quadrature.VEM_Quadrature_2D.Edges_QuadratureData = VEM.Quadrature.VEM_Quadrature_2.Edges_QuadratureData(),
                    diameter: float = float(),
                    measure: float = float(),
                    centroid: Eigen.Vector3d = Eigen.Vector3d(),
                    vander_internal: Eigen.MatrixXd = Eigen.MatrixXd(),
                    vander_internal_kl: Eigen.MatrixXd = Eigen.MatrixXd(),
                    ...
                    pi_nabla: Eigen.MatrixXd = Eigen.MatrixXd(),
                    pi0km1: Eigen.MatrixXd = Eigen.MatrixXd(),
                    pi0k: Eigen.MatrixXd = Eigen.MatrixXd(),
                    pi0klm1: Eigen.MatrixXd = Eigen.MatrixXd(),
                    pi0km1_der: List[Eigen.MatrixXd] = List[Eigen.MatrixXd](),
                    hmatrix: Eigen.MatrixXd = Eigen.MatrixXd(),
                    h_klm1_matrix: Eigen.MatrixXd = Eigen.MatrixXd(),
                    cmatrix: Eigen.MatrixXd = Eigen.MatrixXd(),
                    ...
                    qmatrix_inv: Eigen.MatrixXd = Eigen.MatrixXd(),
                    qmatrixkm1: Eigen.MatrixXd = Eigen.MatrixXd(),
                    inertia_data: Utilities.Inertia_Utilities.Inertia_Data = Utilities.Inertia_Utilities.Inertia_Data(),
                    inertia_polygon: VEM.PCC.VEM_PCC_2D_Polygon_Geometry = VEM.PCC.VEM_PCC_2D_Polygon_Geometry(),
                    constant_stiff: float = float(),
                    constant_mass: float = float()
                    ) -> None:
                    """Auto-generated default constructor with named params"""
                    pass
        ...
        class pcc:  # Proxy class that introduces typings for the *submodule* pcc
            ...
            class VEM_PCC_3D_LocalSpace:
                ...
                def create_local_space(
                    ...
                    polygonal_faces: List[VEM_PCC_2D_Polygon_Geometry],
        ...
        class pcc:  # Proxy class that introduces typings for the *submodule* pcc
            ...
            class VEM_PCC_3D_LocalSpace_Data:
                ...
                def __init__(
                    ...
                    pi0k: Eigen.MatrixXd = Eigen.MatrixXd(),
                    pi0km1_der: List[Eigen.MatrixXd] = List[Eigen.MatrixXd](),
                    stab_matrix: Eigen.MatrixXd = Eigen.MatrixXd(),
                    stab_matrix_pi0k: Eigen.MatrixXd = Eigen.MatrixXd(),
                    hmatrix: Eigen.MatrixXd = Eigen.MatrixXd(),
                    cmatrix: Eigen.MatrixXd = Eigen.MatrixXd(),
                    bmatrix: Eigen.MatrixXd = Eigen.MatrixXd(),
                    gmatrix: Eigen.MatrixXd = Eigen.MatrixXd(),
                    ...
                    scaled_hmatrix_on_boundary: Eigen.MatrixXd = Eigen.MatrixXd(),
                    vander_face_projections: Eigen.MatrixXd = Eigen.MatrixXd(),
                    face_scaled_moments_basis: List[Eigen.MatrixXd] = List[Eigen.MatrixXd](),
                    face_projected_basis_functions_values: List[Eigen.MatrixXd] = List[Eigen.MatrixXd](),
                    point_edge_dofs_coordinates: Eigen.MatrixXd = Eigen.MatrixXd(),
                    vander_boundary_derivatives: List[Eigen.MatrixXd] = List[Eigen.MatrixXd](),
                    qmatrix: Eigen.MatrixXd = Eigen.MatrixXd(),
                    qmatrix_inv: Eigen.MatrixXd = Eigen.MatrixXd(),
                    qmatrixkm1: Eigen.MatrixXd = Eigen.MatrixXd(),
                    inertia_data: Utilities.Inertia_Utilities.Inertia_Data = Utilities.Inertia_Utilities.Inertia_Data(),
                    inertia_polyhedron: VEM.PCC.VEM_PCC_3D_Polyhedron_Geometry = VEM.PCC.VEM_PCC_3D_Polyhedron_Geometry(),
                    constant_stiff: float = float(),
                    constant_mass: float = float(),
