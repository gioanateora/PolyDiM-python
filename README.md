...
The official [documentation](https://polydim.it/) provides a comprehensive description of the library, while practical examples illustrating the use of PyPolyDiM are available in the [GitHub repository](https://github.com/AURION-Polito/PyPolyDiM).
