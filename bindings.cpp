...
void py_init_module_polydim(py::module &m)
{
    ...
    { // <namespace Gedim>
        py::module_ pyNsGedim = m.def_submodule("gedim", "namespace Gedim");
        auto pyNsGedim_ClassConformerMeshPolygon =
            py::class_<Gedim::ConformerMeshPolygon>
                (pyNsGedim, "ConformerMeshPolygon", py::is_final(), "\n(final class)");

        { // inner classes & enums of ConformerMeshPolygon
            auto pyNsGedim_ClassConformerMeshPolygon_ClassConformerMeshPolygonConfiguration =
                py::class_<Gedim::ConformerMeshPolygon::ConformerMeshPolygonConfiguration>
                    (pyNsGedim_ClassConformerMeshPolygon, "ConformerMeshPolygonConfiguration", py::is_final(), "\n(final class)");

            { // inner classes & enums of ConformerMeshPolygonConfiguration
                auto pyEnumTypes =
                    py::enum_<Gedim::ConformerMeshPolygon::ConformerMeshPolygonConfiguration::Types>(pyNsGedim_ClassConformerMeshPolygon_ClassConformerMeshPolygonConfiguration, "Types", py::arithmetic(), "")
                        .value("generalized", Gedim::ConformerMeshPolygon::ConformerMeshPolygonConfiguration::Types::Generalized, "conform checking the intersection types")
                        .value("only_on_edges", Gedim::ConformerMeshPolygon::ConformerMeshPolygonConfiguration::Types::OnlyOnEdges, "mesh 2D is already conform on edges, check only vertices");
            } // end of inner classes & enums of ConformerMeshPolygonConfiguration

            pyNsGedim_ClassConformerMeshPolygon_ClassConformerMeshPolygonConfiguration
                .def(py::init<>([](
                Types Type = Types::Generalized)
                {
                    auto r_ctor_ = std::make_unique<Gedim::ConformerMeshPolygon::ConformerMeshPolygonConfiguration>();
                    r_ctor_->Type = Type;
                    return r_ctor_;
                })
                , py::arg("type") = ConformerMeshPolygonConfiguration::Types::Generalized
                )
                .def_readwrite("type", &Gedim::ConformerMeshPolygon::ConformerMeshPolygonConfiguration::Type, "")
                ;
        } // end of inner classes & enums of ConformerMeshPolygon

        pyNsGedim_ClassConformerMeshPolygon
            .def(py::init<const Gedim::GeometryUtilities &>(),
                py::arg("geometry_utilities"))
            .def(py::init<const Gedim::GeometryUtilities &, const Gedim::ConformerMeshPolygon::ConformerMeshPolygonConfiguration &>(),
                py::arg("geometry_utilities"), py::arg("configuration"))
            .def("create_conform_mesh",
                &Gedim::ConformerMeshPolygon::CreateConformMesh,
                py::arg("segment_origin"), py::arg("segment_end"), py::arg("segment_tangent"), py::arg("mesh1_d"), py::arg("mesh2_d"),
    ...
    { // <namespace Gedim>
        py::module_ pyNsGedim = m.def_submodule("gedim", "namespace Gedim");
        auto pyNsGedim_ClassConformerMeshSegment =
            py::class_<Gedim::ConformerMeshSegment>
                (pyNsGedim, "ConformerMeshSegment", py::is_final(), "\n(final class)");

        { // inner classes & enums of ConformerMeshSegment
            auto pyNsGedim_ClassConformerMeshSegment_ClassConformMesh =
                py::class_<Gedim::ConformerMeshSegment::ConformMesh>
                    (pyNsGedim_ClassConformerMeshSegment, "ConformMesh", py::is_final(), "\n(final class)");

            { // inner classes & enums of ConformMesh
                auto pyNsGedim_ClassConformerMeshSegment_ClassConformMesh_ClassConformMeshPoint =
                    py::class_<Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint>
                        (pyNsGedim_ClassConformerMeshSegment_ClassConformMesh, "ConformMeshPoint", py::is_final(), "\n(final class)");

                { // inner classes & enums of ConformMeshPoint
                    auto pyEnumTypes =
                        py::enum_<Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint::Types>(pyNsGedim_ClassConformerMeshSegment_ClassConformMesh_ClassConformMeshPoint, "Types", py::arithmetic(), "")
                            .value("unknown", Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint::Unknown, "")
                            .value("original", Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint::Original, "/< point belong to original intersection mesh")
                            .value("inherited", Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint::Inherited, "/< point belong to other intersection mesh")
                            .value("external", Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint::External, "/< other points not inherith from intersection mesh");
                } // end of inner classes & enums of ConformMeshPoint

                pyNsGedim_ClassConformerMeshSegment_ClassConformMesh_ClassConformMeshPoint
                    .def(py::init<>([](
                    Types Type = Types())
                    {
                        auto r_ctor_ = std::make_unique<Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint>();
                        r_ctor_->Type = Type;
                        return r_ctor_;
                    })
                    , py::arg("type") = Types()
                    )
                    .def_readwrite("cell2_d_ids", &Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint::Cell2DIds, "")
                    .def_readwrite("edge2_d_ids", &Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint::Edge2DIds, "")
                    .def_readwrite("vertex2_d_ids", &Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint::Vertex2DIds, "")
                    .def_readwrite("type", &Gedim::ConformerMeshSegment::ConformMesh::ConformMeshPoint::Type, "")
                    ;
                auto pyNsGedim_ClassConformerMeshSegment_ClassConformMesh_ClassConformMeshSegment =
                    py::class_<Gedim::ConformerMeshSegment::ConformMesh::ConformMeshSegment>
                        (pyNsGedim_ClassConformerMeshSegment_ClassConformMesh, "ConformMeshSegment", py::is_final(), "\n(final class)")
                    .def(py::init<>([](
                    std::vector<double> Points = {})
                    {
                        auto r_ctor_ = std::make_unique<Gedim::ConformerMeshSegment::ConformMesh::ConformMeshSegment>();
                        r_ctor_->Points = Points;
                        return r_ctor_;
                    })
                    , py::arg("points") = std::vector<double>{}
                    )
                    .def_readwrite("points", &Gedim::ConformerMeshSegment::ConformMesh::ConformMeshSegment::Points, "")
                    .def_readwrite("cell2_d_ids", &Gedim::ConformerMeshSegment::ConformMesh::ConformMeshSegment::Cell2DIds, "")
                    .def_readwrite("edge2_d_ids", &Gedim::ConformerMeshSegment::ConformMesh::ConformMeshSegment::Edge2DIds, "")
                    ;
            } // end of inner classes & enums of ConformMesh

            pyNsGedim_ClassConformerMeshSegment_ClassConformMesh
                .def(py::init<>([](
                std::vector<ConformMeshSegment> Segments = std::vector<ConformMeshSegment>())
                {
                    auto r_ctor_ = std::make_unique<Gedim::ConformerMeshSegment::ConformMesh>();
                    r_ctor_->Segments = Segments;
                    return r_ctor_;
                })
                , py::arg("segments") = std::vector<ConformMeshSegment>()
                )
                .def_readwrite("points", &Gedim::ConformerMeshSegment::ConformMesh::Points, "")
                .def_readwrite("segments", &Gedim::ConformerMeshSegment::ConformMesh::Segments, "")
                ;
        } // end of inner classes & enums of ConformerMeshSegment

        pyNsGedim_ClassConformerMeshSegment
            .def_static("to_curvilinear_coordinates",
                &Gedim::ConformerMeshSegment::ToCurvilinearCoordinates,
                py::arg("conform_mesh"), py::arg("curvilinear_coordinates"),
                "/ \\brief convert IntersectionMesh to Curvilinear Coordinates vector")
            .def_static("to_string",
                &Gedim::ConformerMeshSegment::ToString, py::arg("conform_mesh"))
            .def_static("create_conform_segments",
                &Gedim::ConformerMeshSegment::CreateConformSegments, py::arg("result"))
            .def_static("serialize",
                &Gedim::ConformerMeshSegment::Serialize, py::arg("os"), py::arg("mesh"))
            .def_static("deserialize",
                &Gedim::ConformerMeshSegment::Deserialize, py::arg("is_"), py::arg("mesh"))
            .def(py::init<const Gedim::GeometryUtilities &>(),
                py::arg("geometry_utilities"))
            .def("create_conform_mesh",
                &Gedim::ConformerMeshSegment::CreateConformMesh,
                py::arg("mesh_intersection"), py::arg("mesh_union"), py::arg("mesh_intersection_position"), py::arg("result"),
            ...
            .def("insert_external_point",
                &Gedim::ConformerMeshSegment::InsertExternalPoint,
                py::arg("segment_origin"), py::arg("segment_end"), py::arg("mesh2_d"), py::arg("curvilinear_coordinate"), py::arg("result"),
            ...
            .def("update_with_updated_mesh2_d",
                &Gedim::ConformerMeshSegment::UpdateWithUpdatedMesh2D,
                py::arg("mesh2_d"), py::arg("conformed_mesh"),
            ...
            .def("update_with_active_mesh2_d",
                &Gedim::ConformerMeshSegment::UpdateWithActiveMesh2D,
                py::arg("active_mesh2_d_data"), py::arg("conformed_mesh"),
            ...
            .def("add_missing_mesh2_d_cell0_ds",
                &Gedim::ConformerMeshSegment::AddMissingMesh2DCell0Ds,
                py::arg("segment_origin"), py::arg("segment_tangent"), py::arg("segment_squared_length"), py::arg("mesh2_d"), py::arg("conformed_mesh"),
    ...
    { // <namespace Gedim>
        py::module_ pyNsGedim = m.def_submodule("gedim", "namespace Gedim");
        auto pyNsGedim_ClassConformMeshUtilities =
            py::class_<Gedim::ConformMeshUtilities>
                (pyNsGedim, "ConformMeshUtilities", py::is_final(), "\n(final class)");

        { // inner classes & enums of ConformMeshUtilities
            auto pyNsGedim_ClassConformMeshUtilities_ClassComputeDomainConformedMeshOptions =
                py::class_<Gedim::ConformMeshUtilities::ComputeDomainConformedMeshOptions>
                    (pyNsGedim_ClassConformMeshUtilities, "ComputeDomainConformedMeshOptions", py::is_final(), "\n(final class)")
                .def(py::init<>([](
                bool PrintStatus = false, std::string VtkExportFolder = "")
                {
                    auto r_ctor_ = std::make_unique<Gedim::ConformMeshUtilities::ComputeDomainConformedMeshOptions>();
                    r_ctor_->PrintStatus = PrintStatus;
                    r_ctor_->VtkExportFolder = VtkExportFolder;
                    return r_ctor_;
                })
                , py::arg("print_status") = false, py::arg("vtk_export_folder") = ""
                )
                .def_readwrite("print_status", &Gedim::ConformMeshUtilities::ComputeDomainConformedMeshOptions::PrintStatus, "")
                .def_readwrite("vtk_export_folder", &Gedim::ConformMeshUtilities::ComputeDomainConformedMeshOptions::VtkExportFolder, "")
                ;
        } // end of inner classes & enums of ConformMeshUtilities

        pyNsGedim_ClassConformMeshUtilities
            .def(py::init<const GeometryUtilities &, const MeshUtilities &>(),
                py::arg("geometry_utilities"), py::arg("mesh_utilities"))
            .def("compute_conformed_mesh_with_segments",
                &Gedim::ConformMeshUtilities::ComputeConformedMeshWithSegments, py::arg("segments_additional_points"), py::arg("segments_vertices"), py::arg("segments_tangent"), py::arg("segments_barycenter"), py::arg("segments_length"), py::arg("segments_squared_length"), py::arg("domain_mesh"), py::arg("segments_intersection_mesh"), py::arg("segments_curvilinear_coordinates_mesh"), py::arg("segments_union_mesh"), py::arg("segments_conform_mesh"), py::arg("conform_domain_mesh_type"), py::arg("options"))
            .def("add_conformed_mesh_properties",
                &Gedim::ConformMeshUtilities::AddConformedMeshProperties, py::arg("segments_conform_mesh"), py::arg("conformed_mesh"))
            ;
    } // </namespace Gedim>
    ////////////////////    </generated_from:ConformMeshUtilities.hpp>    ////////////////////
    ...
    { // <namespace Gedim>
        py::module_ pyNsGedim = m.def_submodule("gedim", "namespace Gedim");
        auto pyNsGedim_ClassIMeshDAO =
            py::class_<Gedim::IMeshDAO>
                (pyNsGedim, "IMeshDAO", "/ \\brief The IMeshDAO (mesh data access object) class to read and write mesh data")
            .def(py::init<>()) // implicit default constructor
            .def("initialize_dimension",
                &Gedim::IMeshDAO::InitializeDimension,
                py::arg("dimension"),
                "/ \\brief Initialize the mesh dimension")
            .def("dimension",
                &Gedim::IMeshDAO::Dimension, "/ \\return the geometric dimension of the mesh")
            .def("cell0_ds_initialize",
                &Gedim::IMeshDAO::Cell0DsInitialize,
                py::arg("number_cell0_ds"),
            ...
            .def("cell0_d_remove",
                &Gedim::IMeshDAO::Cell0DRemove,
                py::arg("cell0_d_index"),
            ...
            .def("cell0_d_insert_coordinates",
                &Gedim::IMeshDAO::Cell0DInsertCoordinates,
                py::arg("cell0_d_index"), py::arg("coordinates"),
                "/ \\brief Add the Cell0D Coordinates\n/ \\param cell0DIndex the index of Cell0D from 0 to Cell0DTotalNumber()\n/ \\param coordinates the coordinates of the Cell0D")
            .def("cell0_ds_insert_coordinates",
                &Gedim::IMeshDAO::Cell0DsInsertCoordinates,
                py::arg("coordinates"),
            ...
            .def("cell0_d_set_marker",
                &Gedim::IMeshDAO::Cell0DSetMarker,
                py::arg("cell0_d_index"), py::arg("marker"),
                "/ \\brief Set the Cell0D Marker\n/ \\param cell0DIndex the index of Cell0D from 0 to Cell0DTotalNumber()\n/ \\param marker the marker of the Cell0D")
            .def("cell0_d_set_state",
                &Gedim::IMeshDAO::Cell0DSetState,
                py::arg("cell0_d_index"), py::arg("state"),
                "/ \\brief Set the Cell0D state\n/ \\param cell0DIndex the index of Cell0D from 0 to Cell0DTotalNumber()\n/ \\param state True if Cell0D is active, False otherwise")
            .def("cell0_d_total_number",
                &Gedim::IMeshDAO::Cell0DTotalNumber, "/ \\return the total number of Cell0Ds")
            .def("cell0_d_coordinate_x",
                &Gedim::IMeshDAO::Cell0DCoordinateX,
                py::arg("cell0_d_index"),
                "/ \\param cell0DIndex the index of cell0D from 0 to Cell0DTotalNumber()\n/ \\return the X coordinate of cell0D")
            .def("cell0_d_coordinate_y",
                &Gedim::IMeshDAO::Cell0DCoordinateY,
                py::arg("cell0_d_index"),
                "/ \\param cell0DIndex the index of cell0D from 0 to Cell0DTotalNumber()\n/ \\return the Y coordinate of cell0D")
            .def("cell0_d_coordinate_z",
                &Gedim::IMeshDAO::Cell0DCoordinateZ,
                py::arg("cell0_d_index"),
                "/ \\param cell0DIndex the index of cell0D from 0 to Cell0DTotalNumber()\n/ \\return the Z coordinate of cell0D")
            .def("cell0_d_coordinates",
                &Gedim::IMeshDAO::Cell0DCoordinates,
                py::arg("cell0_d_index"),
                "/ \\param cell0DIndex the index of cell0D from 0 to Cell0DTotalNumber()\n/ \\return the coordinates as Eigen Vector3 of cell0D, size 3x1")
            .def("cell0_ds_coordinates",
                [](Gedim::IMeshDAO & self) { return self.Cell0DsCoordinates(); })
            .def("cell0_ds_coordinates",
                py::overload_cast<const std::vector<unsigned int> &>(&Gedim::IMeshDAO::Cell0DsCoordinates, py::const_), py::arg("cell0_ds"))
            .def("cell0_d_is_active",
                &Gedim::IMeshDAO::Cell0DIsActive,
                py::arg("cell0_d_index"),
                "/ \\param cell0DIndex the index of cell0D from 0 to Cell0DTotalNumber()\n/ \\return if the cell0D is active")
            .def("cell0_d_marker",
                &Gedim::IMeshDAO::Cell0DMarker, py::arg("cell0_d_index"))
            .def("cell0_ds_marker",
                &Gedim::IMeshDAO::Cell0DsMarker)
            .def("cell0_d_has_updated_cell0_ds",
                &Gedim::IMeshDAO::Cell0DHasUpdatedCell0Ds,
                py::arg("cell0_d_index"),
                "/ \\param cell0DIndex the index of cell0D from 0 to Cell0DTotalNumber()\n/ \\return if the cell0D has new cell0Ds associated")
            .def("cell0_d_number_updated_cell0_ds",
                &Gedim::IMeshDAO::Cell0DNumberUpdatedCell0Ds,
                py::arg("cell0_d_index"),
                "/ \\param cell0DIndex the index of cell0D from 0 to Cell0DTotalNumber()\n/ \\return the number of new cell0Ds associated to cell0DIndex")
            .def("cell0_d_has_updated_cell0_d",
                &Gedim::IMeshDAO::Cell0DHasUpdatedCell0D,
                py::arg("cell0_d_index"), py::arg("updated_cell0_d_idex"),
            ...
            .def("cell0_d_insert_updated_cell0_d",
                &Gedim::IMeshDAO::Cell0DInsertUpdatedCell0D,
                py::arg("cell0_d_index"), py::arg("updated_cell0_d_idex"),
                "/ \\brief Add the new Cell0D to an existing Cell0D\n/ \\param cell0DIndex the index of Cell0D from 0 to Cell0DTotalNumber()\n/ \\param updatedCell0DIdex the index of the new cell0D from 0 to Cell0DTotalNumber()")
            .def("cell0_d_updated_cell0_ds",
                &Gedim::IMeshDAO::Cell0DUpdatedCell0Ds,
                py::arg("cell0_d_index"), py::arg("updated_cell0_d_ids"),
            ...
            .def("cell0_ds_neighbour_cell1_ds",
                &Gedim::IMeshDAO::Cell0DsNeighbourCell1Ds)
            .def("cell0_ds_initialize_neighbour_cell1_ds",
                &Gedim::IMeshDAO::Cell0DsInitializeNeighbourCell1Ds,
                py::arg("numbers_neighbour_cell1_ds"),
            ...
            .def("cell0_d_initialize_neighbour_cell1_ds",
                py::overload_cast<const unsigned int &, const unsigned int &>(&Gedim::IMeshDAO::Cell0DInitializeNeighbourCell1Ds), py::arg("cell0_d_index"), py::arg("number_neighbour_cell1_ds"))
            .def("cell0_d_initialize_neighbour_cell1_ds",
                py::overload_cast<const unsigned int &, const std::vector<unsigned int> &>(&Gedim::IMeshDAO::Cell0DInitializeNeighbourCell1Ds), py::arg("cell0_d_index"), py::arg("neighbour_cell1_ds"))
            .def("cell0_d_insert_neighbour_cell1_d",
                &Gedim::IMeshDAO::Cell0DInsertNeighbourCell1D,
                py::arg("cell0_d_index"), py::arg("neighbour_index"), py::arg("neigbour_cell1_d_index"),
            ...
            .def("cell0_d_number_neighbour_cell1_d",
                &Gedim::IMeshDAO::Cell0DNumberNeighbourCell1D,
                py::arg("cell0_d_index"),
                "/ \\param cell0DIndex the index of cell0D from 0 to Cell0DTotalNumber()\n/ \\return the number of Neighbour Cell1Ds of Cell0D")
            .def("cell0_d_neighbour_cell1_d",
                &Gedim::IMeshDAO::Cell0DNeighbourCell1D,
                py::arg("cell0_d_index"), py::arg("neighbour_index"),
            ...
            .def("cell0_ds_neighbour_cell2_ds",
                &Gedim::IMeshDAO::Cell0DsNeighbourCell2Ds)
            .def("cell0_ds_initialize_neighbour_cell2_ds",
                &Gedim::IMeshDAO::Cell0DsInitializeNeighbourCell2Ds,
                py::arg("numbers_neighbour_cell2_ds"),
            ...
            .def("cell0_d_initialize_neighbour_cell2_ds",
                py::overload_cast<const unsigned int &, const unsigned int &>(&Gedim::IMeshDAO::Cell0DInitializeNeighbourCell2Ds), py::arg("cell0_d_index"), py::arg("number_neighbour_cell2_ds"))
            .def("cell0_d_initialize_neighbour_cell2_ds",
                py::overload_cast<const unsigned int &, const std::vector<unsigned int> &>(&Gedim::IMeshDAO::Cell0DInitializeNeighbourCell2Ds), py::arg("cell0_d_index"), py::arg("neighbour_cell2_ds"))
            .def("cell0_d_insert_neighbour_cell2_d",
                &Gedim::IMeshDAO::Cell0DInsertNeighbourCell2D,
                py::arg("cell0_d_index"), py::arg("neighbour_index"), py::arg("neigbour_cell2_d_index"),
            ...
            .def("cell0_d_number_neighbour_cell2_d",
                &Gedim::IMeshDAO::Cell0DNumberNeighbourCell2D,
                py::arg("cell0_d_index"),
                "/ \\param cell0DIndex the index of cell0D from 0 to Cell0DTotalNumber()\n/ \\return the number of Neighbour Cell2Ds of Cell0D")
            .def("cell0_d_neighbour_cell2_d",
                &Gedim::IMeshDAO::Cell0DNeighbourCell2D,
                py::arg("cell0_d_index"), py::arg("neighbour_index"),
            ...
            .def("cell0_ds_neighbour_cell3_ds",
                &Gedim::IMeshDAO::Cell0DsNeighbourCell3Ds)
            .def("cell0_ds_initialize_neighbour_cell3_ds",
                &Gedim::IMeshDAO::Cell0DsInitializeNeighbourCell3Ds,
                py::arg("numbers_neighbour_cell3_ds"),
            ...
            .def("cell0_d_initialize_neighbour_cell3_ds",
                py::overload_cast<const unsigned int &, const unsigned int &>(&Gedim::IMeshDAO::Cell0DInitializeNeighbourCell3Ds), py::arg("cell0_d_index"), py::arg("number_neighbour_cell3_ds"))
            .def("cell0_d_initialize_neighbour_cell3_ds",
                py::overload_cast<const unsigned int &, const std::vector<unsigned int> &>(&Gedim::IMeshDAO::Cell0DInitializeNeighbourCell3Ds), py::arg("cell0_d_index"), py::arg("neighbour_cell3_ds"))
            .def("cell0_d_insert_neighbour_cell3_d",
                &Gedim::IMeshDAO::Cell0DInsertNeighbourCell3D,
                py::arg("cell0_d_index"), py::arg("neighbour_index"), py::arg("neigbour_cell3_d_index"),
            ...
            .def("cell0_d_number_neighbour_cell3_d",
                &Gedim::IMeshDAO::Cell0DNumberNeighbourCell3D,
                py::arg("cell0_d_index"),
                "/ \\param cell0DIndex the index of cell0D from 0 to Cell0DTotalNumber()\n/ \\return the number of Neighbour Cell3Ds of Cell0D")
            .def("cell0_d_neighbour_cell3_d",
                &Gedim::IMeshDAO::Cell0DNeighbourCell3D, py::arg("cell0_d_index"), py::arg("neighbour_index"))
            .def("cell0_d_neighbour_cell3_ds",
                &Gedim::IMeshDAO::Cell0DNeighbourCell3Ds, py::arg("cell0_d_index"))
            .def("cell0_d_has_neighbour_cell3_d",
                &Gedim::IMeshDAO::Cell0DHasNeighbourCell3D,
                py::arg("cell0_d_index"), py::arg("neighbour_index"),
            ...
            .def("cell0_d_reset_neighbour_cell3_d",
                &Gedim::IMeshDAO::Cell0DResetNeighbourCell3D,
                py::arg("cell0_d_index"), py::arg("neighbour_index"),
            ...
            .def("cell0_d_initialize_double_properties",
                &Gedim::IMeshDAO::Cell0DInitializeDoubleProperties,
                py::arg("number_double_properties"),
            ...
            .def("cell0_d_add_double_property",
                &Gedim::IMeshDAO::Cell0DAddDoubleProperty,
                py::arg("property_id"),
            ...
            .def("cell0_ds_initialize_double_property_values",
                &Gedim::IMeshDAO::Cell0DsInitializeDoublePropertyValues,
                py::arg("property_index"), py::arg("porperty_sizes"),
            ...
            .def("cell0_d_initialize_double_property_values",
                &Gedim::IMeshDAO::Cell0DInitializeDoublePropertyValues,
                py::arg("cell0_d_index"), py::arg("property_index"), py::arg("porperty_size"),
            ...
            .def("cell0_d_insert_double_property_value",
                &Gedim::IMeshDAO::Cell0DInsertDoublePropertyValue,
                py::arg("cell0_d_index"), py::arg("property_index"), py::arg("property_value_index"), py::arg("property_value"),
                "/ \\brief Insert the Cell0Ds double property value at position\n/ \\param cell0DIndex the index of Cell0D from 0 to Cell0DTotalNumber()\n/ \\param propertyIndex the index of Cell0D double property from 0 to Cell0DNumberProperties()\n/ \\param propertyIndex the index of Cell0D double property from 0 to Cell0DNumberProperties()")
            .def("cell0_d_number_double_properties",
                &Gedim::IMeshDAO::Cell0DNumberDoubleProperties, "/ \\return the total number of double properties of Cell0Ds")
            .def("cell0_d_double_property_id",
                &Gedim::IMeshDAO::Cell0DDoublePropertyId,
                py::arg("property_index"),
                "/ \\return the id of the double property of Cell0Ds\n/ \\param propertyIndex the index of Cell0D double property from 0 to Cell0DNumberProperties()")
            .def("cell0_d_double_property_exists",
                &Gedim::IMeshDAO::Cell0DDoublePropertyExists,
                py::arg("property_id"),
            ...
            .def("cell0_d_double_property_index",
                &Gedim::IMeshDAO::Cell0DDoublePropertyIndex,
                py::arg("property_id"),
            ...
            .def("cell0_d_double_property_size",
                &Gedim::IMeshDAO::Cell0DDoublePropertySize,
                py::arg("cell0_d_index"), py::arg("property_index"),
                "/ \\return the size of the double property of Cell0D\n/ \\param cell0DIndex the index of Cell0D from 0 to Cell0DTotalNumber()\n/ \\param propertyIndex the index of Cell0D double property from 0 to Cell0DNumberProperties()")
            .def("cell0_d_double_property_value",
                &Gedim::IMeshDAO::Cell0DDoublePropertyValue,
                py::arg("cell0_d_index"), py::arg("property_index"), py::arg("property_value_index"),
            ...
            .def("cell1_ds_initialize",
                &Gedim::IMeshDAO::Cell1DsInitialize,
                py::arg("number_cell1_ds"),
            ...
            .def("cell1_d_insert_extremes",
                &Gedim::IMeshDAO::Cell1DInsertExtremes,
                py::arg("cell1_d_index"), py::arg("origin_cell0_d_index"), py::arg("end_cell0_d_index"),
            ...
            .def("cell1_ds_insert_extremes",
                &Gedim::IMeshDAO::Cell1DsInsertExtremes,
                py::arg("cell1_d_extremes"),
            ...
            .def("cell1_ds_extremes",
                [](Gedim::IMeshDAO & self) { return self.Cell1DsExtremes(); }, "/ \\return the extrems as Eigen MatrixXi of cell1Ds, size 2xCell1DTotalNumber()")
            .def("cell1_d_extremes",
                &Gedim::IMeshDAO::Cell1DExtremes, py::arg("cell1_d_index"))
            .def("cell1_ds_extremes",
                py::overload_cast<const std::vector<unsigned int> &>(&Gedim::IMeshDAO::Cell1DsExtremes, py::const_), py::arg("cell1_ds"))
            .def("cell1_d_by_extremes",
                &Gedim::IMeshDAO::Cell1DByExtremes,
                py::arg("origin_cell0_d_index"), py::arg("end_cell0_d_index"),
            ...
            .def("cell1_d_insert_updated_cell1_d",
                &Gedim::IMeshDAO::Cell1DInsertUpdatedCell1D,
                py::arg("cell1_d_index"), py::arg("updated_cell1_d_idex"),
                "/ \\brief Add the new Cell1D to an existing Cell1D\n/ \\param cell1DIndex the index of Cell1D from 0 to Cell1DTotalNumber()\n/ \\param updatedCell1DIdex the index of the new Cell1D from 0 to Cell1DTotalNumber()")
            .def("cell1_d_updated_cell1_ds",
                &Gedim::IMeshDAO::Cell1DUpdatedCell1Ds,
                py::arg("cell1_d_index"), py::arg("updated_cell1_d_ids"),
            ...
            .def("cell1_ds_neighbour_cell2_ds",
                &Gedim::IMeshDAO::Cell1DsNeighbourCell2Ds)
            .def("cell1_ds_initialize_neighbour_cell2_ds",
                py::overload_cast<const std::vector<unsigned int> &>(&Gedim::IMeshDAO::Cell1DsInitializeNeighbourCell2Ds),
                py::arg("numbers_neighbour_cell2_ds"),
            ...
            .def("cell1_ds_initialize_neighbour_cell2_ds",
                py::overload_cast<const unsigned int &>(&Gedim::IMeshDAO::Cell1DsInitializeNeighbourCell2Ds),
                py::arg("number_neighbour_cell2_ds"),
                "/ \\brief Initialize the Cell1Ds Cell2D neighbours number\n/ \\param numberNeighbourCell2Ds the number of Cell2D neighbours of the Cell1D")
            .def("cell1_d_initialize_neighbour_cell2_ds",
                py::overload_cast<const unsigned int &, const unsigned int &>(&Gedim::IMeshDAO::Cell1DInitializeNeighbourCell2Ds), py::arg("cell1_d_index"), py::arg("number_neighbour_cell2_ds"))
            .def("cell1_d_initialize_neighbour_cell2_ds",
                py::overload_cast<const unsigned int &, const std::vector<unsigned int> &>(&Gedim::IMeshDAO::Cell1DInitializeNeighbourCell2Ds), py::arg("cell1_d_index"), py::arg("neighbour_cell2_ds"))
            .def("cell1_d_insert_neighbour_cell2_d",
                &Gedim::IMeshDAO::Cell1DInsertNeighbourCell2D,
                py::arg("cell1_d_index"), py::arg("neighbour_index"), py::arg("neigbour_cell2_d_index"),
            ...
            .def("cell1_d_number_neighbour_cell2_d",
                &Gedim::IMeshDAO::Cell1DNumberNeighbourCell2D,
                py::arg("cell1_d_index"),
                "/ \\param cell1DIndex the index of cell1D from 0 to Cell1DTotalNumber()\n/ \\return the number of Neighbour Cell2Ds of Cell1D")
            .def("cell1_d_neighbour_cell2_d",
                &Gedim::IMeshDAO::Cell1DNeighbourCell2D,
                py::arg("cell1_d_index"), py::arg("neighbour_index"),
            ...
            .def("cell1_ds_neighbour_cell3_ds",
                &Gedim::IMeshDAO::Cell1DsNeighbourCell3Ds)
            .def("cell1_ds_initialize_neighbour_cell3_ds",
                &Gedim::IMeshDAO::Cell1DsInitializeNeighbourCell3Ds,
                py::arg("numbers_neighbour_cell3_ds"),
            ...
            .def("cell1_d_initialize_neighbour_cell3_ds",
                py::overload_cast<const unsigned int &, const unsigned int &>(&Gedim::IMeshDAO::Cell1DInitializeNeighbourCell3Ds), py::arg("cell1_d_index"), py::arg("number_neighbour_cell3_ds"))
            .def("cell1_d_initialize_neighbour_cell3_ds",
                py::overload_cast<const unsigned int &, const std::vector<unsigned int> &>(&Gedim::IMeshDAO::Cell1DInitializeNeighbourCell3Ds), py::arg("cell1_d_index"), py::arg("neighbour_cell3_ds"))
            .def("cell1_d_insert_neighbour_cell3_d",
                &Gedim::IMeshDAO::Cell1DInsertNeighbourCell3D,
                py::arg("cell1_d_index"), py::arg("neighbour_index"), py::arg("neigbour_cell3_d_index"),
            ...
            .def("cell1_d_number_neighbour_cell3_d",
                &Gedim::IMeshDAO::Cell1DNumberNeighbourCell3D,
                py::arg("cell1_d_index"),
                "/ \\param cell1DIndex the index of cell1D from 0 to Cell1DTotalNumber()\n/ \\return the number of Neighbour Cell3Ds of Cell1D")
            .def("cell1_d_neighbour_cell3_d",
                &Gedim::IMeshDAO::Cell1DNeighbourCell3D, py::arg("cell1_d_index"), py::arg("neighbour_index"))
            .def("cell1_d_neighbour_cell3_ds",
                &Gedim::IMeshDAO::Cell1DNeighbourCell3Ds, py::arg("cell1_d_index"))
            .def("cell1_d_has_neighbour_cell3_d",
                &Gedim::IMeshDAO::Cell1DHasNeighbourCell3D,
                py::arg("cell1_d_index"), py::arg("neighbour_index"),
            ...
            .def("cell1_d_reset_neighbour_cell3_d",
                &Gedim::IMeshDAO::Cell1DResetNeighbourCell3D,
                py::arg("cell1_d_index"), py::arg("neighbour_index"),
            ...
            .def("cell1_d_initialize_double_properties",
                &Gedim::IMeshDAO::Cell1DInitializeDoubleProperties,
                py::arg("number_double_properties"),
            ...
            .def("cell1_d_add_double_property",
                &Gedim::IMeshDAO::Cell1DAddDoubleProperty,
                py::arg("property_id"),
            ...
            .def("cell1_ds_initialize_double_property_values",
                &Gedim::IMeshDAO::Cell1DsInitializeDoublePropertyValues,
                py::arg("property_index"), py::arg("porperty_sizes"),
            ...
            .def("cell1_d_initialize_double_property_values",
                &Gedim::IMeshDAO::Cell1DInitializeDoublePropertyValues,
                py::arg("cell1_d_index"), py::arg("property_index"), py::arg("porperty_size"),
            ...
            .def("cell1_d_insert_double_property_value",
                &Gedim::IMeshDAO::Cell1DInsertDoublePropertyValue,
                py::arg("cell1_d_index"), py::arg("property_index"), py::arg("property_value_index"), py::arg("property_value"),
                "/ \\brief Insert the Cell1Ds double property value at position\n/ \\param cell1DIndex the index of Cell1D from 0 to Cell1DTotalNumber()\n/ \\param propertyIndex the index of Cell1D double property from 0 to Cell1DNumberProperties()\n/ \\param propertyIndex the index of Cell1D double property from 0 to Cell1DNumberProperties()")
            .def("cell1_d_number_double_properties",
                &Gedim::IMeshDAO::Cell1DNumberDoubleProperties, "/ \\return the total number of double properties of Cell1Ds")
            .def("cell1_d_double_property_id",
                &Gedim::IMeshDAO::Cell1DDoublePropertyId,
                py::arg("property_index"),
                "/ \\return the id of the double property of Cell1Ds\n/ \\param propertyIndex the index of Cell1D double property from 0 to Cell1DNumberProperties()")
            .def("cell1_d_double_property_exists",
                &Gedim::IMeshDAO::Cell1DDoublePropertyExists,
                py::arg("property_id"),
            ...
            .def("cell1_d_double_property_index",
                &Gedim::IMeshDAO::Cell1DDoublePropertyIndex,
                py::arg("property_id"),
            ...
            .def("cell1_d_double_property_size",
                &Gedim::IMeshDAO::Cell1DDoublePropertySize,
                py::arg("cell1_d_index"), py::arg("property_index"),
                "/ \\return the size of the double property of Cell1D\n/ \\param cell1DIndex the index of Cell1D from 0 to Cell1DTotalNumber()\n/ \\param propertyIndex the index of Cell1D double property from 0 to Cell1DNumberProperties()")
            .def("cell1_d_double_property_value",
                &Gedim::IMeshDAO::Cell1DDoublePropertyValue,
                py::arg("cell1_d_index"), py::arg("property_index"), py::arg("property_value_index"),
            ...
            .def("cell2_ds_initialize",
                &Gedim::IMeshDAO::Cell2DsInitialize,
                py::arg("number_cell2_ds"),
            ...
            .def("cell2_d_remove",
                &Gedim::IMeshDAO::Cell2DRemove,
                py::arg("cell2_d_index"),
            ...
            .def("cell2_ds_initialize_vertices",
                py::overload_cast<const unsigned int &>(&Gedim::IMeshDAO::Cell2DsInitializeVertices),
                py::arg("number_cell2_d_vertices"),
                "/ \\brief Initialize the Cell2Ds vertices number\n/ \\param numberCell2DVertices the number of vertices of all Cell2Ds")
            .def("cell2_ds_initialize_vertices",
                py::overload_cast<const std::vector<unsigned int> &>(&Gedim::IMeshDAO::Cell2DsInitializeVertices),
                py::arg("number_cell2_ds_vertices"),
                "/ \\brief Initialize the Cell2Ds vertices number\n/ \\param numberCell2DsVertices the number of vertices of each Cell2D")
            .def("cell2_d_initialize_vertices",
                &Gedim::IMeshDAO::Cell2DInitializeVertices,
                py::arg("cell2_d_index"), py::arg("number_cell2_d_vertices"),
            ...
            .def("cell2_ds_initialize_edges",
                py::overload_cast<const unsigned int &>(&Gedim::IMeshDAO::Cell2DsInitializeEdges),
                py::arg("number_cell2_d_edges"),
                "/ \\brief Initialize the Cell2Ds edges number\n/ \\param numberCell2DEdges the number of edges of all Cell2Ds")
            .def("cell2_ds_initialize_edges",
                py::overload_cast<const std::vector<unsigned int> &>(&Gedim::IMeshDAO::Cell2DsInitializeEdges),
                py::arg("number_cell2_ds_edges"),
                "/ \\brief Initialize the Cell2Ds edges number\n/ \\param numberCell2DsEdges the number of edges of each Cell2D")
            .def("cell2_d_initialize_edges",
                &Gedim::IMeshDAO::Cell2DInitializeEdges,
                py::arg("cell2_d_index"), py::arg("number_cell2_d_edges"),
                "/ \\brief Initialize the Cell2D edges number\n/ \\param cell2DIndex the index of Cell2D from 0 to Cell2DTotalNumber()\n/ \\param numberCell2DEdges the number of edges of Cell2D")
            .def("cell2_d_insert_vertices",
                &Gedim::IMeshDAO::Cell2DInsertVertices,
                py::arg("cell2_d_index"), py::arg("vertices_cell0_d_indices"),
            ...
            .def("cell2_d_insert_vertex",
                &Gedim::IMeshDAO::Cell2DInsertVertex,
                py::arg("cell2_d_index"), py::arg("vertex_index"), py::arg("vertex_cell0_d_index"),
            ...
            .def("cell2_d_add_vertices",
                &Gedim::IMeshDAO::Cell2DAddVertices,
                py::arg("cell2_d_index"), py::arg("vertices_cell0_d_indices"),
            ...
            .def("cell2_d_insert_edges",
                &Gedim::IMeshDAO::Cell2DInsertEdges,
                py::arg("cell2_d_index"), py::arg("edges_cell1_d_indices"),
            ...
            .def("cell2_d_insert_edge",
                &Gedim::IMeshDAO::Cell2DInsertEdge,
                py::arg("cell2_d_index"), py::arg("edge_index"), py::arg("edge_cell1_d_index"),
            ...
            .def("cell2_d_add_edges",
                &Gedim::IMeshDAO::Cell2DAddEdges,
                py::arg("cell2_d_index"), py::arg("edges_cell1_d_indices"),
                "/ \\brief Add the Cell2D edges\n/ \\param cell2DIndex the index of Cell2D from 0 to Cell2DTotalNumber()\n/ \\param edgesCell1DIndices the Cell1D edges indices from 0 to Cell1DTotalNumber()\n/ \note No itialization is necessary")
            .def("cell2_d_add_vertices_and_edges",
                &Gedim::IMeshDAO::Cell2DAddVerticesAndEdges,
                py::arg("cell2_d_index"), py::arg("vertices_and_edges_indices"),
            ...
            .def("cell2_d_set_marker",
                &Gedim::IMeshDAO::Cell2DSetMarker,
                py::arg("cell2_d_index"), py::arg("marker"),
                "/ \\brief Set the Cell2D Marker\n/ \\param cell2DIndex the index of Cell2D from 0 to Cell2DTotalNumber()\n/ \\param marker the marker of the Cell2D")
            .def("cell2_d_set_state",
                &Gedim::IMeshDAO::Cell2DSetState,
                py::arg("cell2_d_index"), py::arg("state"),
                "/ \\brief Set the Cell1D state\n/ \\param cell2DIndex the index of Cell2D from 0 to Cell2DTotalNumber()\n/ \\param state True if Cell1D is active, False otherwise")
            .def("cell2_d_total_number",
                &Gedim::IMeshDAO::Cell2DTotalNumber, "/ \\return the total number of Cell2Ds")
            .def("cell2_d_number_vertices",
                &Gedim::IMeshDAO::Cell2DNumberVertices,
                py::arg("cell2_d_index"),
                "/ \\param cell2DIndex the index of cell2D from 0 to Cell2DTotalNumber()\n/ \\return the number of vertices of Cell2D")
            .def("cell2_d_number_edges",
                &Gedim::IMeshDAO::Cell2DNumberEdges,
                py::arg("cell2_d_index"),
                "/ \\param cell2DIndex the index of cell2D from 0 to Cell2DTotalNumber()\n/ \\return the number of edges of Cell2D")
            .def("cell2_ds_vertices",
                &Gedim::IMeshDAO::Cell2DsVertices, "/ \\return the Cell0D index collections of all Cell2Ds, size Cell2DTotalNumber() x\n/ Cell2DNumberVertices(cell2DIndex)")
            .def("cell2_ds_extremes",
                &Gedim::IMeshDAO::Cell2DsExtremes, "/ \\return the Cell0Ds and Cell1Ds index collections of all Cell2Ds, size Cell2DTotalNumber() x (2 x\n/ Cell2DNumberVertices(cell2DIndex))")
            .def("cell2_d_vertices",
                &Gedim::IMeshDAO::Cell2DVertices,
                py::arg("cell2_d_index"),
                "/ \\param cell2DIndex the index of cell2D from 0 to Cell2DTotalNumber()\n/ \\return the Cell0D index collections of Cell2D from 0 to Cell0DTotalNumber(), size\n/ Cell2DNumberVertices(cell2DIndex)")
            .def("cell2_d_vertex",
                &Gedim::IMeshDAO::Cell2DVertex,
                py::arg("cell2_d_index"), py::arg("vertex_index"),
            ...
            .def("cell2_d_find_vertex",
                &Gedim::IMeshDAO::Cell2DFindVertex,
                py::arg("cell2_d_index"), py::arg("cell0_d_index"),
            ...
            .def("cell2_d_find_edge",
                &Gedim::IMeshDAO::Cell2DFindEdge,
                py::arg("cell2_d_index"), py::arg("cell1_d_index"),
            ...
            .def("cell2_d_find_edge_by_extremes",
                &Gedim::IMeshDAO::Cell2DFindEdgeByExtremes,
                py::arg("cell2_d_index"), py::arg("origin_cell0_d_index"), py::arg("end_cell0_d_index"),
                "/ \\param cell2DIndex the index of cell2D from 0 to Cell2DTotalNumber()\n/ \\param originCell0DIndex the Cell0D Id of origin from 0 to Cell0DTotalNumber()\n/ \\param endCell0DIndex the Cell0D Id of origin from 0 to Cell0DTotalNumber()\n/ \\return the index of the cell1DIndex on the cell2D from 0 to NumberCell2DEdges(cell2DIndex),\n/ NumberCell2DEdges(cell2DIndex) otherwise")
            .def("cell2_d_marker",
                &Gedim::IMeshDAO::Cell2DMarker, py::arg("cell2_d_index"))
            .def("cell2_ds_marker",
                &Gedim::IMeshDAO::Cell2DsMarker)
            .def("cell2_d_is_active",
                &Gedim::IMeshDAO::Cell2DIsActive,
                py::arg("cell2_d_index"),
                "/ \\param cell2DIndex the index of cell2D from 0 to Cell2DTotalNumber()\n/ \\return if the cell2D is active")
            .def("cell2_d_has_updated_cell2_ds",
                &Gedim::IMeshDAO::Cell2DHasUpdatedCell2Ds,
                py::arg("cell2_d_index"),
                "/ \\param cell2DIndex the index of cell2D from 0 to Cell2DTotalNumber()\n/ \\return if the cell2D has new cell2Ds associated")
            .def("cell2_d_number_updated_cell2_ds",
                &Gedim::IMeshDAO::Cell2DNumberUpdatedCell2Ds,
                py::arg("cell2_d_index"),
                "/ \\param cell2DIndex the index of cell2D from 0 to Cell2DTotalNumber()\n/ \\return the number of new cell2Ds associated to cell2DIndex")
            .def("cell2_d_has_updated_cell2_d",
                &Gedim::IMeshDAO::Cell2DHasUpdatedCell2D,
                py::arg("cell2_d_index"), py::arg("updated_cell2_d_index"),
            ...
            .def("cell2_d_insert_updated_cell2_d",
                &Gedim::IMeshDAO::Cell2DInsertUpdatedCell2D,
                py::arg("cell2_d_index"), py::arg("updated_cell2_d_idex"),
            ...
            .def("cell2_ds_neighbour_cell3_ds",
                &Gedim::IMeshDAO::Cell2DsNeighbourCell3Ds)
            .def("cell2_ds_initialize_neighbour_cell3_ds",
                &Gedim::IMeshDAO::Cell2DsInitializeNeighbourCell3Ds,
                py::arg("numbers_neighbour_cell3_ds"),
            ...
            .def("cell2_d_initialize_neighbour_cell3_ds",
                py::overload_cast<const unsigned int &, const unsigned int &>(&Gedim::IMeshDAO::Cell2DInitializeNeighbourCell3Ds), py::arg("cell2_d_index"), py::arg("number_neighbour_cell3_ds"))
            .def("cell2_d_initialize_neighbour_cell3_ds",
                py::overload_cast<const unsigned int &, const std::vector<unsigned int> &>(&Gedim::IMeshDAO::Cell2DInitializeNeighbourCell3Ds), py::arg("cell2_d_index"), py::arg("neighbour_cell3_ds"))
            .def("cell2_d_insert_neighbour_cell3_d",
                &Gedim::IMeshDAO::Cell2DInsertNeighbourCell3D,
                py::arg("cell2_d_index"), py::arg("neighbour_index"), py::arg("neigbour_cell3_d_index"),
            ...
            .def("cell2_d_number_neighbour_cell3_d",
                &Gedim::IMeshDAO::Cell2DNumberNeighbourCell3D,
                py::arg("cell2_d_index"),
                "/ \\param cell2DIndex the index of cell2D from 0 to Cell2DTotalNumber()\n/ \\return the number of Neighbour Cell3Ds of Cell2D")
            .def("cell2_d_neighbour_cell3_d",
                &Gedim::IMeshDAO::Cell2DNeighbourCell3D, py::arg("cell2_d_index"), py::arg("neighbour_index"))
            .def("cell2_d_neighbour_cell3_ds",
                &Gedim::IMeshDAO::Cell2DNeighbourCell3Ds, py::arg("cell2_d_index"))
            .def("cell2_d_has_neighbour_cell3_d",
                &Gedim::IMeshDAO::Cell2DHasNeighbourCell3D,
                py::arg("cell2_d_index"), py::arg("neighbour_index"),
            ...
            .def("cell2_d_reset_neighbour_cell3_d",
                &Gedim::IMeshDAO::Cell2DResetNeighbourCell3D,
                py::arg("cell2_d_index"), py::arg("neighbour_index"),
            ...
            .def("cell2_d_initialize_double_properties",
                &Gedim::IMeshDAO::Cell2DInitializeDoubleProperties,
                py::arg("number_double_properties"),
            ...
            .def("cell2_d_add_double_property",
                &Gedim::IMeshDAO::Cell2DAddDoubleProperty,
                py::arg("property_id"),
            ...
            .def("cell2_ds_initialize_double_property_values",
                &Gedim::IMeshDAO::Cell2DsInitializeDoublePropertyValues,
                py::arg("property_index"), py::arg("porperty_sizes"),
            ...
            .def("cell2_d_initialize_double_property_values",
                &Gedim::IMeshDAO::Cell2DInitializeDoublePropertyValues,
                py::arg("cell2_d_index"), py::arg("property_index"), py::arg("porperty_size"),
            ...
            .def("cell2_d_insert_double_property_value",
                &Gedim::IMeshDAO::Cell2DInsertDoublePropertyValue,
                py::arg("cell2_d_index"), py::arg("property_index"), py::arg("property_value_index"), py::arg("property_value"),
                "/ \\brief Insert the Cell2Ds double property value at position\n/ \\param cell2DIndex the index of Cell2D from 0 to Cell2DTotalNumber()\n/ \\param propertyIndex the index of Cell2D double property from 0 to Cell2DNumberProperties()\n/ \\param propertyIndex the index of Cell2D double property from 0 to Cell2DNumberProperties()")
            .def("cell2_d_number_double_properties",
                &Gedim::IMeshDAO::Cell2DNumberDoubleProperties, "/ \\return the total number of double properties of Cell2Ds")
            .def("cell2_d_double_property_id",
                &Gedim::IMeshDAO::Cell2DDoublePropertyId,
                py::arg("property_index"),
                "/ \\return the id of the double property of Cell2Ds\n/ \\param propertyIndex the index of Cell2D double property from 0 to Cell2DNumberProperties()")
            .def("cell2_d_double_property_exists",
                &Gedim::IMeshDAO::Cell2DDoublePropertyExists,
                py::arg("property_id"),
            ...
            .def("cell2_d_double_property_index",
                &Gedim::IMeshDAO::Cell2DDoublePropertyIndex,
                py::arg("property_id"),
            ...
            .def("cell2_d_double_property_size",
                &Gedim::IMeshDAO::Cell2DDoublePropertySize,
                py::arg("cell2_d_index"), py::arg("property_index"),
                "/ \\return the size of the double property of Cell2D\n/ \\param cell2DIndex the index of Cell2D from 0 to Cell2DTotalNumber()\n/ \\param propertyIndex the index of Cell2D double property from 0 to Cell2DNumberProperties()")
            .def("cell2_d_double_property_value",
                &Gedim::IMeshDAO::Cell2DDoublePropertyValue,
                py::arg("cell2_d_index"), py::arg("property_index"), py::arg("property_value_index"),
            ...
            .def("cell2_ds_initialize_sub_division",
                &Gedim::IMeshDAO::Cell2DsInitializeSubDivision,
                py::arg("number_sub_divisions"),
            ...
            .def("cell2_d_initialize_sub_division",
                &Gedim::IMeshDAO::Cell2DInitializeSubDivision,
                py::arg("cell2_d_index"), py::arg("number_sub_division"),
            ...
            .def("cell2_d_insert_sub_division",
                &Gedim::IMeshDAO::Cell2DInsertSubDivision,
                py::arg("cell2_d_index"), py::arg("sub_division_index"), py::arg("cell2_d_vertex_index"),
            ...
            .def("cell2_d_number_sub_division",
                &Gedim::IMeshDAO::Cell2DNumberSubDivision,
                py::arg("cell2_d_index"),
            ...
            .def("cell2_d_sub_division_cell0_d",
                &Gedim::IMeshDAO::Cell2DSubDivisionCell0D,
                py::arg("cell2_d_index"), py::arg("sub_division_index"),
            ...
            .def("cell3_ds_initialize",
                &Gedim::IMeshDAO::Cell3DsInitialize,
                py::arg("number_cell3_ds"),
            ...
            .def("cell3_d_remove",
                &Gedim::IMeshDAO::Cell3DRemove,
                py::arg("cell3_d_index"),
            ...
            .def("cell3_ds_initialize_vertices",
                &Gedim::IMeshDAO::Cell3DsInitializeVertices,
                py::arg("number_cell3_ds_vertices"),
            ...
            .def("cell3_d_initialize_vertices",
                &Gedim::IMeshDAO::Cell3DInitializeVertices,
                py::arg("cell3_d_index"), py::arg("number_cell3_d_vertices"),
            ...
            .def("cell3_ds_initialize_edges",
                &Gedim::IMeshDAO::Cell3DsInitializeEdges,
                py::arg("number_cell3_ds_edges"),
            ...
            .def("cell3_d_initialize_edges",
                &Gedim::IMeshDAO::Cell3DInitializeEdges,
                py::arg("cell3_d_index"), py::arg("number_cell3_d_edges"),
            ...
            .def("cell3_ds_initialize_faces",
                &Gedim::IMeshDAO::Cell3DsInitializeFaces,
                py::arg("number_cell3_ds_faces"),
            ...
            .def("cell3_d_initialize_faces",
                &Gedim::IMeshDAO::Cell3DInitializeFaces,
                py::arg("cell3_d_index"), py::arg("number_cell3_d_faces"),
                "/ \\brief Initialize the Cell3D faces number\n/ \\param cell3DIndex the index of Cell3D from 0 to Cell3DTotalNumber()\n/ \\param numberCell3DFaces the number of faces of Cell3D")
            .def("cell3_d_insert_vertex",
                &Gedim::IMeshDAO::Cell3DInsertVertex,
                py::arg("cell3_d_index"), py::arg("vertex_index"), py::arg("vertex_cell0_d_index"),
            ...
            .def("cell3_d_add_vertices",
                &Gedim::IMeshDAO::Cell3DAddVertices,
                py::arg("cell3_d_index"), py::arg("vertices_cell0_d_indices"),
                "/ \\brief Add the Cell3D vertices\n/ \\param cell3DIndex the index of Cell3D from 0 to Cell3DTotalNumber()\n/ \\param vertexCell0DIndices the Cell0D vertices indices from 0 to Cell0DTotalNumber()\n/ \note No itialization is necessary")
            .def("cell3_d_insert_edge",
                &Gedim::IMeshDAO::Cell3DInsertEdge,
                py::arg("cell3_d_index"), py::arg("edge_index"), py::arg("edge_cell1_d_index"),
            ...
            .def("cell3_d_add_edges",
                &Gedim::IMeshDAO::Cell3DAddEdges,
                py::arg("cell3_d_index"), py::arg("edges_cell0_d_indices"),
            ...
            .def("cell3_d_find_vertex",
                &Gedim::IMeshDAO::Cell3DFindVertex,
                py::arg("cell3_d_index"), py::arg("cell0_d_index"),
            ...
            .def("cell3_d_find_edge",
                &Gedim::IMeshDAO::Cell3DFindEdge,
                py::arg("cell3_d_index"), py::arg("cell1_d_index"),
            ...
            .def("cell3_d_find_face",
                &Gedim::IMeshDAO::Cell3DFindFace,
                py::arg("cell3_d_index"), py::arg("cell2_d_index"),
            ...
            .def("cell3_d_find_edge_by_extremes",
                &Gedim::IMeshDAO::Cell3DFindEdgeByExtremes,
                py::arg("cell3_d_index"), py::arg("origin_cell0_d_index"), py::arg("end_cell0_d_index"),
                "/ \\param cell3DIndex the index of cell3D from 0 to Cell3DTotalNumber()\n/ \\param originCell0DIndex the Cell0D Id of origin from 0 to Cell0DTotalNumber()\n/ \\param endCell0DIndex the Cell0D Id of origin from 0 to Cell0DTotalNumber()\n/ \\return the index of the cell1DIndex on the cell2D from 0 to NumberCell2DEdges(cell3DIndex),\n/ NumberCell2DEdges(cell2DIndex) otherwise")
            .def("cell3_d_insert_face",
                &Gedim::IMeshDAO::Cell3DInsertFace,
                py::arg("cell3_d_index"), py::arg("face_index"), py::arg("face_cell2_d_index"),
            ...
            .def("cell3_d_add_faces",
                &Gedim::IMeshDAO::Cell3DAddFaces,
                py::arg("cell3_d_index"), py::arg("faces_cell0_d_indices"),
            ...
            .def("cell3_ds_faces_vertices",
                &Gedim::IMeshDAO::Cell3DsFacesVertices, "/ \\return the Cell0D index collections of all the faces of all Cell3Ds, size Cell3DTotalNumber() x\n/ Cell3DNumberFaces(cell3DIndex) x Cell2DNumberVertices(cell2DIndex)")
            .def("cell3_ds_vertices",
                &Gedim::IMeshDAO::Cell3DsVertices, "/ \\return the Cell0D index collections of all Cell3Ds, size Cell3DTotalNumber() x\n/ Cell3DNumberVertices(cell3DIndex)")
            .def("cell3_ds_edges",
                &Gedim::IMeshDAO::Cell3DsEdges, "/ \\return the Cell1D index collections of all Cell3Ds, size Cell3DTotalNumber() x Cell3DNumberEdges(cell3DIndex)")
            .def("cell3_ds_faces",
                &Gedim::IMeshDAO::Cell3DsFaces, "/ \\return the Cell2D index collections of all Cell3Ds, size Cell3DTotalNumber() x Cell3DNumberFaces(cell3DIndex)")
            .def("cell3_d_face",
                &Gedim::IMeshDAO::Cell3DFace,
                py::arg("cell3_d_index"), py::arg("face_index"),
            ...
            .def("cell3_d_insert_updated_cell3_d",
                &Gedim::IMeshDAO::Cell3DInsertUpdatedCell3D,
                py::arg("cell3_d_index"), py::arg("updated_cell3_d_idex"),
                "/ \\brief Add the new Cell3D to an existing Cell3D\n/ \\param cell3DIndex the index of Cell3D from 0 to Cell3DTotalNumber()\n/ \\param updatedCell3DIdex the index of the new Cell3D from 0 to Cell3DTotalNumber()")
            .def("cell3_d_updated_cell3_ds",
                &Gedim::IMeshDAO::Cell3DUpdatedCell3Ds,
                py::arg("cell3_d_index"), py::arg("updated_cell3_d_ids"),
            ...
            .def("cell3_d_initialize_double_properties",
                &Gedim::IMeshDAO::Cell3DInitializeDoubleProperties,
                py::arg("number_double_properties"),
            ...
            .def("cell3_d_add_double_property",
                &Gedim::IMeshDAO::Cell3DAddDoubleProperty,
                py::arg("property_id"),
            ...
            .def("cell3_ds_initialize_double_property_values",
                &Gedim::IMeshDAO::Cell3DsInitializeDoublePropertyValues,
                py::arg("property_index"), py::arg("porperty_sizes"),
            ...
            .def("cell3_d_initialize_double_property_values",
                &Gedim::IMeshDAO::Cell3DInitializeDoublePropertyValues,
                py::arg("cell3_d_index"), py::arg("property_index"), py::arg("porperty_size"),
            ...
            .def("cell3_d_insert_double_property_value",
                &Gedim::IMeshDAO::Cell3DInsertDoublePropertyValue,
                py::arg("cell3_d_index"), py::arg("property_index"), py::arg("property_value_index"), py::arg("property_value"),
                "/ \\brief Insert the Cell3Ds double property value at position\n/ \\param cell3DIndex the index of Cell3D from 0 to Cell3DTotalNumber()\n/ \\param propertyIndex the index of Cell3D double property from 0 to Cell3DNumberProperties()\n/ \\param propertyIndex the index of Cell3D double property from 0 to Cell3DNumberProperties()")
            .def("cell3_d_number_double_properties",
                &Gedim::IMeshDAO::Cell3DNumberDoubleProperties, "/ \\return the total number of double properties of Cell3Ds")
            .def("cell3_d_double_property_id",
                &Gedim::IMeshDAO::Cell3DDoublePropertyId,
                py::arg("property_index"),
                "/ \\return the id of the double property of Cell3Ds\n/ \\param propertyIndex the index of Cell3D double property from 0 to Cell3DNumberProperties()")
            .def("cell3_d_double_property_exists",
                &Gedim::IMeshDAO::Cell3DDoublePropertyExists,
                py::arg("property_id"),
            ...
            .def("cell3_d_double_property_index",
                &Gedim::IMeshDAO::Cell3DDoublePropertyIndex,
                py::arg("property_id"),
            ...
            .def("cell3_d_double_property_size",
                &Gedim::IMeshDAO::Cell3DDoublePropertySize,
                py::arg("cell3_d_index"), py::arg("property_index"),
                "/ \\return the size of the double property of Cell3D\n/ \\param cell3DIndex the index of Cell3D from 0 to Cell3DTotalNumber()\n/ \\param propertyIndex the index of Cell3D double property from 0 to Cell3DNumberProperties()")
            .def("cell3_d_double_property_value",
                &Gedim::IMeshDAO::Cell3DDoublePropertyValue,
                py::arg("cell3_d_index"), py::arg("property_index"), py::arg("property_value_index"),
            ...
            .def("compress",
                &Gedim::IMeshDAO::Compress, "/ \\brief Compact the mesh to save memory")
            .def("to_string",
                &Gedim::IMeshDAO::ToString, "/ \\return The mesh converted to string")
            ;
    } // </namespace Gedim>
    ////////////////////    </generated_from:IMeshDAO.hpp>    ////////////////////
    ...
    { // <namespace Gedim>
        py::module_ pyNsGedim = m.def_submodule("gedim", "namespace Gedim");
        auto pyNsGedim_ClassIntersectorMesh2DSegment =
            py::class_<Gedim::IntersectorMesh2DSegment>
                (pyNsGedim, "IntersectorMesh2DSegment", py::is_final(), "\n(final class)");

        { // inner classes & enums of IntersectorMesh2DSegment
            auto pyNsGedim_ClassIntersectorMesh2DSegment_ClassIntersectionMesh =
                py::class_<Gedim::IntersectorMesh2DSegment::IntersectionMesh>
                    (pyNsGedim_ClassIntersectorMesh2DSegment, "IntersectionMesh", py::is_final(), "\n(final class)");

            { // inner classes & enums of IntersectionMesh
                auto pyNsGedim_ClassIntersectorMesh2DSegment_ClassIntersectionMesh_ClassIntersectionMeshPoint =
                    py::class_<Gedim::IntersectorMesh2DSegment::IntersectionMesh::IntersectionMeshPoint>
                        (pyNsGedim_ClassIntersectorMesh2DSegment_ClassIntersectionMesh, "IntersectionMeshPoint", py::is_final(), "\n(final class)")
                    .def(py::init<>()) // implicit default constructor
                    .def_readwrite("cell2_d_ids", &Gedim::IntersectorMesh2DSegment::IntersectionMesh::IntersectionMeshPoint::Cell2DIds, "")
                    .def_readwrite("edge2_d_ids", &Gedim::IntersectorMesh2DSegment::IntersectionMesh::IntersectionMeshPoint::Edge2DIds, "")
                    .def_readwrite("vertex2_d_ids", &Gedim::IntersectorMesh2DSegment::IntersectionMesh::IntersectionMeshPoint::Vertex2DIds, "")
                    ;
                auto pyNsGedim_ClassIntersectorMesh2DSegment_ClassIntersectionMesh_ClassIntersectionMeshSegment =
                    py::class_<Gedim::IntersectorMesh2DSegment::IntersectionMesh::IntersectionMeshSegment>
                        (pyNsGedim_ClassIntersectorMesh2DSegment_ClassIntersectionMesh, "IntersectionMeshSegment", py::is_final(), "\n(final class)")
                    .def(py::init<>([](
                    std::vector<double> Points = {})
                    {
                        auto r_ctor_ = std::make_unique<Gedim::IntersectorMesh2DSegment::IntersectionMesh::IntersectionMeshSegment>();
                        r_ctor_->Points = Points;
                        return r_ctor_;
                    })
                    , py::arg("points") = std::vector<double>{}
                    )
                    .def_readwrite("points", &Gedim::IntersectorMesh2DSegment::IntersectionMesh::IntersectionMeshSegment::Points, "")
                    .def_readwrite("cell2_d_ids", &Gedim::IntersectorMesh2DSegment::IntersectionMesh::IntersectionMeshSegment::Cell2DIds, "")
                    .def_readwrite("edge2_d_ids", &Gedim::IntersectorMesh2DSegment::IntersectionMesh::IntersectionMeshSegment::Edge2DIds, "")
                    ;
            } // end of inner classes & enums of IntersectionMesh

            pyNsGedim_ClassIntersectorMesh2DSegment_ClassIntersectionMesh
                .def(py::init<>([](
                std::vector<IntersectionMeshSegment> Segments = std::vector<IntersectionMeshSegment>())
                {
                    auto r_ctor_ = std::make_unique<Gedim::IntersectorMesh2DSegment::IntersectionMesh>();
                    r_ctor_->Segments = Segments;
                    return r_ctor_;
                })
                , py::arg("segments") = std::vector<IntersectionMeshSegment>()
                )
                .def_readwrite("points", &Gedim::IntersectorMesh2DSegment::IntersectionMesh::Points, "")
                .def_readwrite("segments", &Gedim::IntersectorMesh2DSegment::IntersectionMesh::Segments, "")
                ;
        } // end of inner classes & enums of IntersectorMesh2DSegment

        pyNsGedim_ClassIntersectorMesh2DSegment
            .def_static("to_curvilinear_coordinates",
                &Gedim::IntersectorMesh2DSegment::ToCurvilinearCoordinates,
                py::arg("intersecting_mesh"), py::arg("curvilinear_coordinates"),
                "/ \\brief convert IntersectionMesh to Curvilinear Coordinates vector")
            .def_static("to_string",
                &Gedim::IntersectorMesh2DSegment::ToString, py::arg("intersecting_mesh"))
            .def(py::init<const Gedim::IMeshDAO &, const Gedim::GeometryUtilities &>(),
                py::arg("mesh"), py::arg("geometry_utilities"))
            .def("create_intersection_mesh",
                &Gedim::IntersectorMesh2DSegment::CreateIntersectionMesh, py::arg("segment_origin"), py::arg("segment_end"), py::arg("segment_tangent"), py::arg("segment_barycenter"), py::arg("segment_length"), py::arg("result"))
            ;
    } // </namespace Gedim>
    ////////////////////    </generated_from:IntersectorMesh2DSegment.hpp>    ////////////////////
    ...
    { // <namespace Gedim>
        py::module_ pyNsGedim = m.def_submodule("gedim", "namespace Gedim");
        auto pyNsGedim_ClassIntersectorMesh3DSegment =
            py::class_<Gedim::IntersectorMesh3DSegment>
                (pyNsGedim, "IntersectorMesh3DSegment", py::is_final(), "\n(final class)");

        { // inner classes & enums of IntersectorMesh3DSegment
            auto pyNsGedim_ClassIntersectorMesh3DSegment_ClassIntersectionMesh =
                py::class_<Gedim::IntersectorMesh3DSegment::IntersectionMesh>
                    (pyNsGedim_ClassIntersectorMesh3DSegment, "IntersectionMesh", py::is_final(), "\n(final class)");

            { // inner classes & enums of IntersectionMesh
                auto pyNsGedim_ClassIntersectorMesh3DSegment_ClassIntersectionMesh_ClassIntersectionMeshPoint =
                    py::class_<Gedim::IntersectorMesh3DSegment::IntersectionMesh::IntersectionMeshPoint>
                        (pyNsGedim_ClassIntersectorMesh3DSegment_ClassIntersectionMesh, "IntersectionMeshPoint", py::is_final(), "\n(final class)")
                    .def(py::init<>([](
                    double CurvilinearCoordinate = double(), std::vector<GeometryUtilities::PointPolyhedronPositionResult> Positions = std::vector<GeometryUtilities::PointPolyhedronPositionResult>())
                    {
                        auto r_ctor_ = std::make_unique<Gedim::IntersectorMesh3DSegment::IntersectionMesh::IntersectionMeshPoint>();
                        r_ctor_->CurvilinearCoordinate = CurvilinearCoordinate;
                        r_ctor_->Positions = Positions;
                        return r_ctor_;
                    })
                    , py::arg("curvilinear_coordinate") = double(), py::arg("positions") = std::vector<GeometryUtilities::PointPolyhedronPositionResult>()
                    )
                    .def_readwrite("curvilinear_coordinate", &Gedim::IntersectorMesh3DSegment::IntersectionMesh::IntersectionMeshPoint::CurvilinearCoordinate, "")
                    .def_readwrite("cell3_d_ids", &Gedim::IntersectorMesh3DSegment::IntersectionMesh::IntersectionMeshPoint::Cell3DIds, "")
                    .def_readwrite("positions", &Gedim::IntersectorMesh3DSegment::IntersectionMesh::IntersectionMeshPoint::Positions, "")
                    ;
                auto pyNsGedim_ClassIntersectorMesh3DSegment_ClassIntersectionMesh_ClassIntersectionMeshSegment =
                    py::class_<Gedim::IntersectorMesh3DSegment::IntersectionMesh::IntersectionMeshSegment>
                        (pyNsGedim_ClassIntersectorMesh3DSegment_ClassIntersectionMesh, "IntersectionMeshSegment", py::is_final(), "\n(final class)")
                    .def(py::init<>([](
                    std::vector<GeometryUtilities::SegmentPolyhedronPositionResult> Positions = std::vector<GeometryUtilities::SegmentPolyhedronPositionResult>())
                    {
                        auto r_ctor_ = std::make_unique<Gedim::IntersectorMesh3DSegment::IntersectionMesh::IntersectionMeshSegment>();
                        r_ctor_->Positions = Positions;
                        return r_ctor_;
                    })
                    , py::arg("positions") = std::vector<GeometryUtilities::SegmentPolyhedronPositionResult>()
                    )
                    .def_readwrite("points_index", &Gedim::IntersectorMesh3DSegment::IntersectionMesh::IntersectionMeshSegment::PointsIndex, "")
                    .def_readwrite("cell3_d_ids", &Gedim::IntersectorMesh3DSegment::IntersectionMesh::IntersectionMeshSegment::Cell3DIds, "")
                    .def_readwrite("positions", &Gedim::IntersectorMesh3DSegment::IntersectionMesh::IntersectionMeshSegment::Positions, "")
                    ;
            } // end of inner classes & enums of IntersectionMesh

            pyNsGedim_ClassIntersectorMesh3DSegment_ClassIntersectionMesh
                .def(py::init<>([](
                std::vector<IntersectionMeshPoint> Points = std::vector<IntersectionMeshPoint>(), std::vector<IntersectionMeshSegment> Segments = std::vector<IntersectionMeshSegment>())
                {
                    auto r_ctor_ = std::make_unique<Gedim::IntersectorMesh3DSegment::IntersectionMesh>();
                    r_ctor_->Points = Points;
                    r_ctor_->Segments = Segments;
                    return r_ctor_;
                })
                , py::arg("points") = std::vector<IntersectionMeshPoint>(), py::arg("segments") = std::vector<IntersectionMeshSegment>()
                )
                .def_readwrite("points", &Gedim::IntersectorMesh3DSegment::IntersectionMesh::Points, "")
                .def_readwrite("segments", &Gedim::IntersectorMesh3DSegment::IntersectionMesh::Segments, "")
                ;
            auto pyNsGedim_ClassIntersectorMesh3DSegment_ClassIntersectionPoint =
                py::class_<Gedim::IntersectorMesh3DSegment::IntersectionPoint>
                    (pyNsGedim_ClassIntersectorMesh3DSegment, "IntersectionPoint", py::is_final(), "\n(final class)")
                .def(py::init<>()) // implicit default constructor
                .def_readwrite("cell3_d_ids", &Gedim::IntersectorMesh3DSegment::IntersectionPoint::Cell3DIds, "")
                ;
            auto pyNsGedim_ClassIntersectorMesh3DSegment_ClassFindSegmentStartingCell3DResult =
                py::class_<Gedim::IntersectorMesh3DSegment::FindSegmentStartingCell3DResult>
                    (pyNsGedim_ClassIntersectorMesh3DSegment, "FindSegmentStartingCell3DResult", py::is_final(), "\n(final class)")
                .def(py::init<>([](
                bool SegmentFullInsideCell3D = bool(), GeometryUtilities::PointPolyhedronPositionResult Position = GeometryUtilities::PointPolyhedronPositionResult())
                {
                    auto r_ctor_ = std::make_unique<Gedim::IntersectorMesh3DSegment::FindSegmentStartingCell3DResult>();
                    r_ctor_->SegmentFullInsideCell3D = SegmentFullInsideCell3D;
                    r_ctor_->Position = Position;
                    return r_ctor_;
                })
                , py::arg("segment_full_inside_cell3_d") = bool(), py::arg("position") = GeometryUtilities::PointPolyhedronPositionResult()
                )
                .def_readwrite("starting_cell3_d_index", &Gedim::IntersectorMesh3DSegment::FindSegmentStartingCell3DResult::StartingCell3DIndex, "")
                .def_readwrite("segment_full_inside_cell3_d", &Gedim::IntersectorMesh3DSegment::FindSegmentStartingCell3DResult::SegmentFullInsideCell3D, "")
                .def_readwrite("position", &Gedim::IntersectorMesh3DSegment::FindSegmentStartingCell3DResult::Position, "")
                ;
        } // end of inner classes & enums of IntersectorMesh3DSegment

        pyNsGedim_ClassIntersectorMesh3DSegment
            .def(py::init<const Gedim::GeometryUtilities &, const Gedim::MeshUtilities &>(),
                py::arg("geometry_utilities"), py::arg("mesh_utilities"))
            .def_static("to_curvilinear_coordinates",
                &Gedim::IntersectorMesh3DSegment::ToCurvilinearCoordinates, py::arg("intersecting_mesh"))
            .def_static("mesh_segments_cell3_ds",
                &Gedim::IntersectorMesh3DSegment::MeshSegmentsCell3Ds, py::arg("intersecting_mesh"))
            .def_static("to_string",
                &Gedim::IntersectorMesh3DSegment::ToString, py::arg("intersecting_mesh"))
            .def("create_intersection_mesh",
                &Gedim::IntersectorMesh3DSegment::CreateIntersectionMesh, py::arg("segment_origin"), py::arg("segment_end"), py::arg("segment_tangent"), py::arg("mesh3_d"), py::arg("mesh3_d_geometric_data"))
            .def("find_segment_starting_cell3_d",
                &Gedim::IntersectorMesh3DSegment::FindSegmentStartingCell3D, py::arg("segment_origin"), py::arg("segment_end"), py::arg("mesh3_d"), py::arg("mesh3_d_geometric_data"))
            ;
    } // </namespace Gedim>
    ////////////////////    </generated_from:IntersectorMesh3DSegment.hpp>    ////////////////////
    ...
    { // <namespace Gedim>
        ...
        auto pyNsGedim_ClassMeshDAOExporterToCsv =
            ...
            .def(py::init<const MeshFromCsvUtilities &>(),
                py::arg("utilities"))
            .def("export",
    ...
    { // <namespace Gedim>
        ...
        { // inner classes & enums of MeshFromCsvUtilities
            ...
            pyNsGedim_ClassMeshFromCsvUtilities_ClassCellDoubleProperty
                .def(py::init<>([](
                std::string Id = std::string(), std::string FilePath = std::string(), std::vector<Value> Values = std::vector<Value>())
                {
                ...
                , py::arg("id") = std::string(), py::arg("file_path") = std::string(), py::arg("values") = std::vector<Value>()
                )
    ...
    { // <namespace Gedim>
        ...
        { // inner classes & enums of MeshUtilities
            ...
            pyNsGedim_ClassMeshUtilities_ClassAgglomerateMeshFromTriangularMeshResult
                .def(py::init<>([](
                std::vector<ConcaveCell2D> ConcaveCell2Ds = std::vector<ConcaveCell2D>())
                {
                ...
                , py::arg("concave_cell2_ds") = std::vector<ConcaveCell2D>()
                )
            ...
            pyNsGedim_ClassMeshUtilities_ClassFindConcaveCell3DFacesConvexCell2DResult
                ...
                , py::arg("concave_cell3_d_faces_convex_cell2_d") = std::vector<ConvexCell2D>{}
                )
            ...
            pyNsGedim_ClassMeshUtilities_ClassFindPointMeshPositionResult
                .def(py::init<>([](
                std::vector<PointMeshPosition> MeshPositions = std::vector<PointMeshPosition>())
                {
                    auto r_ctor_ = std::make_unique<Gedim::MeshUtilities::FindPointMeshPositionResult>();
                    r_ctor_->MeshPositions = MeshPositions;
                    return r_ctor_;
                })
                , py::arg("mesh_positions") = std::vector<PointMeshPosition>()
                )
            ...
            { // inner classes & enums of FindPointCell2DResult
                auto pyNsGedim_ClassMeshUtilities_ClassFindPointCell2DResult_ClassPointCell2DFound =
                    ...
                    .def(py::init<>([](
                    GeometryUtilities::PointPolygonPositionResult Cell2D_Position = GeometryUtilities::PointPolygonPositionResult())
                    {
                    ...
                    , py::arg("cell2_d_position") = GeometryUtilities::PointPolygonPositionResult()
                    )
            ...
            pyNsGedim_ClassMeshUtilities_ClassFindPointCell2DResult
                .def(py::init<>([](
                std::vector<PointCell2DFound> Cell2Ds_found = std::vector<PointCell2DFound>())
                {
                    auto r_ctor_ = std::make_unique<Gedim::MeshUtilities::FindPointCell2DResult>();
                    r_ctor_->Cell2Ds_found = Cell2Ds_found;
                    return r_ctor_;
                })
                , py::arg("cell2_ds_found") = std::vector<PointCell2DFound>()
                )
            ...
            { // inner classes & enums of FindPointCell3DResult
                auto pyNsGedim_ClassMeshUtilities_ClassFindPointCell3DResult_ClassPointCell3DFound =
                    ...
                    .def(py::init<>([](
                    GeometryUtilities::PointPolyhedronPositionResult Cell3D_Position = GeometryUtilities::PointPolyhedronPositionResult())
                    {
                    ...
                    , py::arg("cell3_d_position") = GeometryUtilities::PointPolyhedronPositionResult()
                    )
            ...
            pyNsGedim_ClassMeshUtilities_ClassFindPointCell3DResult
                .def(py::init<>([](
                std::vector<PointCell3DFound> Cell3Ds_found = std::vector<PointCell3DFound>())
                {
                    auto r_ctor_ = std::make_unique<Gedim::MeshUtilities::FindPointCell3DResult>();
                    r_ctor_->Cell3Ds_found = Cell3Ds_found;
                    return r_ctor_;
                })
                , py::arg("cell3_ds_found") = std::vector<PointCell3DFound>()
                )
            ...
            pyNsGedim_ClassMeshUtilities_ClassIntersect_mesh_polyhedron_result
                .def(py::init<>([](
                Types Type = Types(), Eigen::MatrixXd Intersections_Coordinates = Eigen::MatrixXd(), std::vector<Polyhedron_Intersection> Polyhedron_intersections = std::vector<Polyhedron_Intersection>(), Mesh_Intersections Mesh_intersections = Mesh_Intersections())
                {
                ...
                , py::arg("type") = Types(), py::arg("intersections_coordinates") = Eigen::MatrixXd(), py::arg("polyhedron_intersections") = std::vector<Polyhedron_Intersection>(), py::arg("mesh_intersections") = Mesh_Intersections()
                )
        ...
        pyNsGedim_ClassMeshUtilities
            ...
            .def("set_mesh_markers_on_polygon",
                py::overload_cast<const GeometryUtilities &, const Eigen::Vector3d &, const Eigen::Vector3d &, const Eigen::MatrixXd &, const Eigen::Vector3d &, const Eigen::Matrix3d &, const unsigned int &, IMeshDAO &>(&Gedim::MeshUtilities::SetMeshMarkersOnPolygon, py::const_),
            ...
            .def("set_mesh_markers_on_polygon",
                py::overload_cast<const GeometryUtilities &, const Eigen::Vector3d &, const Eigen::Vector3d &, const Eigen::MatrixXd &, const Eigen::Vector3d &, const Eigen::Matrix3d &, const std::vector<Eigen::Vector3d> &, const std::vector<Eigen::Vector3d> &, const unsigned int &, IMeshDAO &>(&Gedim::MeshUtilities::SetMeshMarkersOnPolygon, py::const_), py::arg("geometry_utilities"), py::arg("polygon_plane_normal"), py::arg("polygon_plane_origin"), py::arg("polygon_vertices_2_d"), py::arg("polygon_translation"), py::arg("polygon_rotation_matrix"), py::arg("cell1_ds_centroid"), py::arg("cell2_ds_centroid"), py::arg("marker"), py::arg("mesh"))
            ...
            .def("fill_mesh2_d_geometric_data",
                py::overload_cast<const GeometryUtilities &, const IMeshDAO &>(&Gedim::MeshUtilities::FillMesh2DGeometricData, py::const_),
                py::arg("geometry_utilities"), py::arg("convex_mesh"),
                "/ \\brief Fill Mesh2D Geometric Data given a mesh with convex mesh cells\n/ \\param convexMesh the convex mesh\n/ \\return the MeshGeometricData computed")
            .def("fill_mesh2_d_geometric_data",
                py::overload_cast<const GeometryUtilities &, const IMeshDAO &, const std::vector<GeometryUtilities::PolygonTypes> &>(&Gedim::MeshUtilities::FillMesh2DGeometricData, py::const_),
            ...
            .def("fill_mesh2_d_geometric_data",
                py::overload_cast<const GeometryUtilities &, const IMeshDAO &, const IMeshDAO &, const std::vector<std::vector<unsigned int>> &>(&Gedim::MeshUtilities::FillMesh2DGeometricData, py::const_),
            ...
            .def("fill_mesh3_d_geometric_data",
                py::overload_cast<const GeometryUtilities &, const IMeshDAO &>(&Gedim::MeshUtilities::FillMesh3DGeometricData, py::const_),
                py::arg("geometry_utilities"), py::arg("convex_mesh"),
                "/ \\brief Fill Mesh3D Geometric Data given a mesh with convex mesh cells\n/ \\param convexMesh the convex mesh\n/ \\return the MeshGeometricData computed")
            .def("fill_mesh3_d_geometric_data",
                py::overload_cast<const GeometryUtilities &, const IMeshDAO &, const IMeshDAO &, const std::vector<std::vector<unsigned int>> &>(&Gedim::MeshUtilities::FillMesh3DGeometricData, py::const_),
            ...
            .def("fill_mesh3_d_geometric_data",
                py::overload_cast<const GeometryUtilities &, const IMeshDAO &, const std::vector<std::vector<Eigen::MatrixXd>> &, const std::vector<std::vector<Eigen::Matrix3d>> &>(&Gedim::MeshUtilities::FillMesh3DGeometricData, py::const_), py::arg("geometry_utilities"), py::arg("mesh"), py::arg("cell3_ds_tetra_vertices"), py::arg("cell2_ds_triangles_3_d_vertices"))
            ...
            .def("create_tetrahedral_mesh",
                py::overload_cast<const Eigen::MatrixXd &, const Eigen::MatrixXi &, const std::vector<Eigen::MatrixXi> &, const double &, IMeshDAO &, const std::string &>(&Gedim::MeshUtilities::CreateTetrahedralMesh, py::const_), py::arg("polyhedron_vertices"), py::arg("polyhedron_edges"), py::arg("polyhedron_faces"), py::arg("max_tetrahedron_volume"), py::arg("mesh"), py::arg("options") = "Qpqfezna")
            .def("create_tetrahedral_mesh",
                py::overload_cast<const Eigen::MatrixXd &, const std::vector<std::vector<unsigned int>> &, const double &, IMeshDAO &, const std::string &>(&Gedim::MeshUtilities::CreateTetrahedralMesh, py::const_), py::arg("points"), py::arg("facets"), py::arg("max_tetrahedron_volume"), py::arg("mesh"), py::arg("options") = "Qpqfezna")
            ...
            .def("agglomerate_cell1_ds",
                py::overload_cast<const std::unordered_set<unsigned int> &, const IMeshDAO &>(&Gedim::MeshUtilities::AgglomerateCell1Ds, py::const_), py::arg("cell1_ds_index"), py::arg("mesh"))
            .def("agglomerate_cell2_ds",
                py::overload_cast<const GeometryUtilities &, const std::unordered_set<unsigned int> &, const IMeshDAO &>(&Gedim::MeshUtilities::AgglomerateCell2Ds, py::const_), py::arg("geometry_utilities"), py::arg("cell2_ds_index"), py::arg("mesh"))
            .def("agglomerate_cell3_ds",
                py::overload_cast<const std::unordered_set<unsigned int> &, const IMeshDAO &>(&Gedim::MeshUtilities::AgglomerateCell3Ds, py::const_), py::arg("cell3_ds_index"), py::arg("mesh"))
            .def("agglomerate_cell1_ds",
                py::overload_cast<const std::unordered_set<unsigned int> &, const std::vector<unsigned int> &, const std::vector<unsigned int> &, IMeshDAO &, std::vector<std::vector<unsigned int>> &, const bool>(&Gedim::MeshUtilities::AgglomerateCell1Ds, py::const_), py::arg("sub_cell1_ds_index"), py::arg("agglomerate_cell1_d_vertices"), py::arg("sub_cell1_ds_removed_cell0_ds"), py::arg("mesh"), py::arg("mesh_cell1_ds_original_cell1_ds"), py::arg("mantain_neigh2_d_order") = false)
            .def("agglomerate_cell2_ds",
                py::overload_cast<const std::unordered_set<unsigned int> &, const std::vector<unsigned int> &, const std::vector<unsigned int> &, const std::vector<unsigned int> &, const std::vector<unsigned int> &, IMeshDAO &, std::vector<std::vector<unsigned int>> &>(&Gedim::MeshUtilities::AgglomerateCell2Ds, py::const_), py::arg("sub_cell2_ds_index"), py::arg("agglomerate_cell2_d_vertices"), py::arg("agglomerate_cell2_d_edges"), py::arg("sub_cell2_ds_removed_cell0_ds"), py::arg("sub_cell2_ds_removed_cell1_ds"), py::arg("mesh"), py::arg("mesh_cell2_ds_original_cell2_ds"))
            .def("agglomerate_cell3_ds",
                py::overload_cast<const std::unordered_set<unsigned int> &, const std::vector<unsigned int> &, const std::vector<unsigned int> &, const std::vector<unsigned int> &, const std::vector<unsigned int> &, const std::vector<unsigned int> &, const std::vector<unsigned int> &, IMeshDAO &, std::vector<std::vector<unsigned int>> &>(&Gedim::MeshUtilities::AgglomerateCell3Ds, py::const_), py::arg("sub_cell3_ds_index"), py::arg("agglomerate_cell3_d_vertices"), py::arg("agglomerate_cell3_d_edges"), py::arg("agglomerate_cell3_d_faces"), py::arg("sub_cell3_ds_removed_cell0_ds"), py::arg("sub_cell3_ds_removed_cell1_ds"), py::arg("sub_cell3_ds_removed_cell2_ds"), py::arg("mesh"), py::arg("mesh_cell3_ds_original_cell3_ds"))
            ...
            .def("find_concave_cell3_d_faces_convex_cell2_d",
                py::overload_cast<const GeometryUtilities &, const unsigned int &, const IMeshDAO &, const IMeshDAO &, const std::vector<unsigned int> &, const std::vector<Eigen::MatrixXd> &, const std::vector<Eigen::MatrixXd> &, const std::vector<Eigen::Vector3d> &, const std::vector<Eigen::Matrix3d> &, const std::vector<Eigen::Vector3d> &, const std::vector<std::vector<Eigen::MatrixXd>> &, const std::vector<std::vector<std::vector<unsigned int>>> &>(&Gedim::MeshUtilities::FindConcaveCell3DFacesConvexCell2D, py::const_), py::arg("geometry_utilities"), py::arg("concave_cell3_d_index"), py::arg("mesh"), py::arg("convex_mesh"), py::arg("convex_cell3_d_indices"), py::arg("concave_cell3_d_faces3_d_vertices"), py::arg("concave_cell3_d_faces2_d_vertices"), py::arg("concave_cell3_d_faces_translation"), py::arg("concave_cell3_d_faces_rotation_matrix"), py::arg("concave_cell3_d_faces_normal"), py::arg("convex_cell3_ds_faces3_d_vertices"), py::arg("convex_cell3_ds_faces_unaligned_vertices"))
            .def("find_concave_cell3_d_faces_convex_cell2_d",
                py::overload_cast<const GeometryUtilities &, const unsigned int &, const IMeshDAO &, const std::vector<Eigen::MatrixXd> &, const std::vector<std::vector<Eigen::Matrix3d>> &, const std::vector<Eigen::MatrixXd> &, const std::vector<Eigen::Vector3d> &, const std::vector<Eigen::Matrix3d> &, const std::vector<Eigen::Vector3d> &, const std::vector<std::vector<Eigen::MatrixXd>> &, const std::vector<std::vector<std::vector<unsigned int>>> &>(&Gedim::MeshUtilities::FindConcaveCell3DFacesConvexCell2D, py::const_), py::arg("geometry_utilities"), py::arg("concave_cell3_d_index"), py::arg("mesh"), py::arg("concave_cell3_d_tetra"), py::arg("concave_cell3_d_faces_2_d_triangles"), py::arg("concave_cell3_d_faces3_d_vertices"), py::arg("concave_cell3_d_faces_translation"), py::arg("concave_cell3_d_faces_rotation_matrix"), py::arg("concave_cell3_d_faces_normal"), py::arg("convex_cell3_ds_faces3_d_vertices"), py::arg("convex_cell3_ds_faces_unaligned_vertices"))
            .def("find_point_mesh_position",
                py::overload_cast<const Gedim::MeshUtilities::FindPointCell2DResult &, const IMeshDAO &>(&Gedim::MeshUtilities::FindPointMeshPosition, py::const_), py::arg("find_cell2_d_result"), py::arg("mesh"))
            .def("find_point_mesh_position",
                py::overload_cast<const Gedim::MeshUtilities::FindPointCell3DResult &, const IMeshDAO &>(&Gedim::MeshUtilities::FindPointMeshPosition, py::const_), py::arg("find_cell3_d_result"), py::arg("mesh"))
            ...
            .def("find_point_cell3_d",
                py::overload_cast<const GeometryUtilities &, const Eigen::Vector3d &, const IMeshDAO &, const std::vector<std::vector<Eigen::MatrixXi>> &, const std::vector<std::vector<Eigen::MatrixXd>> &, const std::vector<std::vector<Eigen::MatrixXd>> &, const std::vector<std::vector<Eigen::Vector3d>> &, const std::vector<std::vector<bool>> &, const std::vector<std::vector<Eigen::Vector3d>> &, const std::vector<std::vector<Eigen::Matrix3d>> &, const std::vector<Eigen::MatrixXd> &, const bool, const unsigned int>(&Gedim::MeshUtilities::FindPointCell3D, py::const_), py::arg("geometry_utilities"), py::arg("point"), py::arg("mesh"), py::arg("cell3_ds_faces"), py::arg("cell3_ds_face_vertices"), py::arg("cell3_ds_face_rotated_vertices"), py::arg("cell3_ds_face_normals"), py::arg("cell3_ds_face_normal_directions"), py::arg("cell3_ds_face_translations"), py::arg("cell3_ds_face_rotation_matrices"), py::arg("cell3_ds_bounding_box"), py::arg("find_only_first_cell3_d") = true, py::arg("starting_cell3_d_index") = 0)
            .def("find_point_cell3_d",
                py::overload_cast<const GeometryUtilities &, const Eigen::Vector3d &, const IMeshDAO &, const std::vector<std::vector<Eigen::MatrixXi>> &, const std::vector<std::vector<Eigen::MatrixXd>> &, const std::vector<std::vector<Eigen::MatrixXd>> &, const std::vector<std::vector<Eigen::Vector3d>> &, const std::vector<std::vector<bool>> &, const std::vector<std::vector<Eigen::Vector3d>> &, const std::vector<std::vector<Eigen::Matrix3d>> &, const std::vector<Eigen::MatrixXd> &, const std::vector<std::vector<Eigen::MatrixXd>> &, const bool, const unsigned int>(&Gedim::MeshUtilities::FindPointCell3D, py::const_), py::arg("geometry_utilities"), py::arg("point"), py::arg("mesh"), py::arg("cell3_ds_faces"), py::arg("cell3_ds_face_vertices"), py::arg("cell3_ds_face_rotated_vertices"), py::arg("cell3_ds_face_normals"), py::arg("cell3_ds_face_normal_directions"), py::arg("cell3_ds_face_translations"), py::arg("cell3_ds_face_rotation_matrices"), py::arg("cell3_ds_bounding_box"), py::arg("cell3_ds_tetrahedra"), py::arg("find_only_first_cell3_d"), py::arg("starting_cell3_d_index"))
    ...
    { // <namespace Gedim>
        py::module_ pyNsGedim = m.def_submodule("gedim", "namespace Gedim");
        auto pyNsGedim_ClassObjectFileFormatInterface =
            py::class_<Gedim::ObjectFileFormatInterface>
                (pyNsGedim, "ObjectFileFormatInterface", py::is_final(), "\n(final class)");

        { // inner classes & enums of ObjectFileFormatInterface
            auto pyNsGedim_ClassObjectFileFormatInterface_ClassOFFMesh =
                py::class_<Gedim::ObjectFileFormatInterface::OFFMesh>
                    (pyNsGedim_ClassObjectFileFormatInterface, "OFFMesh", py::is_final(), "\n(final class)")
                .def(py::init<>([](
                Eigen::MatrixXd Cell0Ds = Eigen::MatrixXd(), std::vector<Eigen::VectorXi> Cell2Ds = std::vector<Eigen::VectorXi>())
                {
                    auto r_ctor_ = std::make_unique<Gedim::ObjectFileFormatInterface::OFFMesh>();
                    r_ctor_->Cell0Ds = Cell0Ds;
                    r_ctor_->Cell2Ds = Cell2Ds;
                    return r_ctor_;
                })
                , py::arg("cell0_ds") = Eigen::MatrixXd(), py::arg("cell2_ds") = std::vector<Eigen::VectorXi>()
                )
                .def_readwrite("num_cell0_ds", &Gedim::ObjectFileFormatInterface::OFFMesh::NumCell0Ds, "")
                .def_readwrite("num_cell1_ds", &Gedim::ObjectFileFormatInterface::OFFMesh::NumCell1Ds, "")
                .def_readwrite("num_cell2_ds", &Gedim::ObjectFileFormatInterface::OFFMesh::NumCell2Ds, "")
                .def_readwrite("cell0_ds", &Gedim::ObjectFileFormatInterface::OFFMesh::Cell0Ds, "")
                .def_readwrite("cell2_ds", &Gedim::ObjectFileFormatInterface::OFFMesh::Cell2Ds, "")
                ;
        } // end of inner classes & enums of ObjectFileFormatInterface

        pyNsGedim_ClassObjectFileFormatInterface
            .def(py::init<>())
            .def("strings_to_off_mesh",
                &Gedim::ObjectFileFormatInterface::StringsToOFFMesh, py::arg("file_lines"))
            .def("off_mesh_to_strings",
                &Gedim::ObjectFileFormatInterface::OFFMeshToStrings, py::arg("mesh"))
            .def("mesh_dao_to_off_mesh",
                &Gedim::ObjectFileFormatInterface::MeshDAOToOFFMesh, py::arg("original_mesh"))
            .def("off_mesh_to_mesh_dao",
                &Gedim::ObjectFileFormatInterface::OFFMeshToMeshDAO, py::arg("original_mesh"), py::arg("mesh_utilities"), py::arg("converted_mesh"))
            .def("import_mesh_from_file",
                &Gedim::ObjectFileFormatInterface::ImportMeshFromFile, py::arg("off_file_path"), py::arg("mesh_utilities"), py::arg("mesh"))
            .def("export_mesh_to_file",
                &Gedim::ObjectFileFormatInterface::ExportMeshToFile, py::arg("mesh"), py::arg("off_file_path"))
            ;
    } // </namespace Gedim>
    ////////////////////    </generated_from:ObjectFileFormatInterface.hpp>    ////////////////////
    ...
    { // <namespace Gedim>
        py::module_ pyNsGedim = m.def_submodule("gedim", "namespace Gedim");
        auto pyNsGedim_ClassOpenVolumeMeshInterface =
            py::class_<Gedim::OpenVolumeMeshInterface>
                (pyNsGedim, "OpenVolumeMeshInterface", py::is_final(), "\n(final class)");

        { // inner classes & enums of OpenVolumeMeshInterface
            auto pyNsGedim_ClassOpenVolumeMeshInterface_ClassOVMMesh =
                py::class_<Gedim::OpenVolumeMeshInterface::OVMMesh>
                    (pyNsGedim_ClassOpenVolumeMeshInterface, "OVMMesh", py::is_final(), "\n(final class)");

            { // inner classes & enums of OVMMesh
                auto pyNsGedim_ClassOpenVolumeMeshInterface_ClassOVMMesh_ClassCell3D =
                    py::class_<Gedim::OpenVolumeMeshInterface::OVMMesh::Cell3D>
                        (pyNsGedim_ClassOpenVolumeMeshInterface_ClassOVMMesh, "Cell3D", py::is_final(), "\n(final class)")
                    .def(py::init<>([](
                    std::vector<bool> FacesOrientation = std::vector<bool>())
                    {
                        auto r_ctor_ = std::make_unique<Gedim::OpenVolumeMeshInterface::OVMMesh::Cell3D>();
                        r_ctor_->FacesOrientation = FacesOrientation;
                        return r_ctor_;
                    })
                    , py::arg("faces_orientation") = std::vector<bool>()
                    )
                    .def_readwrite("faces_index", &Gedim::OpenVolumeMeshInterface::OVMMesh::Cell3D::FacesIndex, "")
                    .def_readwrite("faces_orientation", &Gedim::OpenVolumeMeshInterface::OVMMesh::Cell3D::FacesOrientation, "")
                    ;
            } // end of inner classes & enums of OVMMesh

            pyNsGedim_ClassOpenVolumeMeshInterface_ClassOVMMesh
                .def(py::init<>([](
                Eigen::MatrixXd Cell0Ds = Eigen::MatrixXd(), Eigen::MatrixXi Cell1Ds = Eigen::MatrixXi(), std::vector<Eigen::MatrixXi> Cell2Ds = std::vector<Eigen::MatrixXi>(), std::vector<Cell3D> Cell3Ds = std::vector<Cell3D>())
                {
                    auto r_ctor_ = std::make_unique<Gedim::OpenVolumeMeshInterface::OVMMesh>();
                    r_ctor_->Cell0Ds = Cell0Ds;
                    r_ctor_->Cell1Ds = Cell1Ds;
                    r_ctor_->Cell2Ds = Cell2Ds;
                    r_ctor_->Cell3Ds = Cell3Ds;
                    return r_ctor_;
                })
                , py::arg("cell0_ds") = Eigen::MatrixXd(), py::arg("cell1_ds") = Eigen::MatrixXi(), py::arg("cell2_ds") = std::vector<Eigen::MatrixXi>(), py::arg("cell3_ds") = std::vector<Cell3D>()
                )
                .def_readwrite("num_cell0_ds", &Gedim::OpenVolumeMeshInterface::OVMMesh::NumCell0Ds, "")
                .def_readwrite("num_cell1_ds", &Gedim::OpenVolumeMeshInterface::OVMMesh::NumCell1Ds, "")
                .def_readwrite("num_cell2_ds", &Gedim::OpenVolumeMeshInterface::OVMMesh::NumCell2Ds, "")
                .def_readwrite("num_cell3_ds", &Gedim::OpenVolumeMeshInterface::OVMMesh::NumCell3Ds, "")
                .def_readwrite("cell0_ds", &Gedim::OpenVolumeMeshInterface::OVMMesh::Cell0Ds, "")
                .def_readwrite("cell1_ds", &Gedim::OpenVolumeMeshInterface::OVMMesh::Cell1Ds, "")
                .def_readwrite("cell2_ds", &Gedim::OpenVolumeMeshInterface::OVMMesh::Cell2Ds, "")
                .def_readwrite("cell3_ds", &Gedim::OpenVolumeMeshInterface::OVMMesh::Cell3Ds, "")
                ;
        } // end of inner classes & enums of OpenVolumeMeshInterface

        pyNsGedim_ClassOpenVolumeMeshInterface
            .def(py::init<>())
            .def("strings_to_ovm_mesh",
                &Gedim::OpenVolumeMeshInterface::StringsToOVMMesh, py::arg("file_lines"))
            .def("ovm_mesh_to_strings",
                &Gedim::OpenVolumeMeshInterface::OVMMeshToStrings, py::arg("mesh"))
            .def("mesh_dao_to_ovm_mesh",
                &Gedim::OpenVolumeMeshInterface::MeshDAOToOVMMesh, py::arg("original_mesh"), py::arg("cell3_ds_faces_orientation"))
            .def("ovm_mesh_to_mesh_dao",
                &Gedim::OpenVolumeMeshInterface::OVMMeshToMeshDAO, py::arg("original_mesh"), py::arg("converted_mesh"), py::arg("converted_mesh_cell3_ds_faces_orientation"))
            .def("import_mesh_from_file",
                &Gedim::OpenVolumeMeshInterface::ImportMeshFromFile, py::arg("ovm_file_path"), py::arg("mesh"), py::arg("mesh_cell3_ds_faces_orientation"))
            .def("export_mesh_to_file",
                &Gedim::OpenVolumeMeshInterface::ExportMeshToFile, py::arg("mesh"), py::arg("mesh_cell3_ds_faces_orientation"), py::arg("ovm_file_path"))
            ;
    } // </namespace Gedim>
    ////////////////////    </generated_from:OpenVolumeMeshInterface.hpp>    ////////////////////
    ...
    { // <namespace Gedim>
        ...
        { // inner classes & enums of RefinementUtilities
            ...
            pyNsGedim_ClassRefinementUtilities_ClassSplitPolygon_Result
                ...
                , py::arg("type") = SplitPolygon_Result::Types::Unknown
                )
            ...
            { // inner classes & enums of RefinePolygon_CheckResult
                ...
                pyNsGedim_ClassRefinementUtilities_ClassRefinePolygon_CheckResult_ClassCell1DToSplit
                    ...
                    , py::arg("is_intersection_inside") = false, py::arg("is_edge_length_enough") = false, py::arg("is_local_quality_enough") = false, py::arg("is_quality_enough") = false, py::arg("is_neigh_quality_enough") = std::vector<bool>{}, py::arg("is_local_aligned_respect") = false, py::arg("is_aligned_respect") = false, py::arg("is_neigh_aligned_respect") = std::vector<bool>{}, py::arg("is_to_split") = false, py::arg("type") = Cell1DToSplit::Types::Unknown
                    )
            ...
            pyNsGedim_ClassRefinementUtilities_ClassRefinePolygon_CheckResult
                .def(py::init<>([](
                std::vector<GeometryUtilities::LinePolygonPositionResult::EdgeIntersection> Cell1DsIntersection = {}, std::vector<Cell1DToSplit> Cell1DsToSplit = {}, ResultTypes ResultType = ResultTypes::Unknown)
                {
                ...
                , py::arg("cell1_ds_intersection") = std::vector<GeometryUtilities::LinePolygonPositionResult::EdgeIntersection>{}, py::arg("cell1_ds_to_split") = std::vector<Cell1DToSplit>{}, py::arg("result_type") = RefinePolygon_CheckResult::ResultTypes::Unknown
                )
            ...
            pyNsGedim_ClassRefinementUtilities_ClassCheckSplitType_Result
                ...
                , py::arg("type") = CheckSplitType_Result::SplitTypes::Unknown
                )
            ...
            { // inner classes & enums of RefinePolyhedron_Result
                ...
                pyNsGedim_ClassRefinementUtilities_ClassRefinePolyhedron_Result_ClassRefinedCell1D
                    ...
                    , py::arg("type") = RefinedCell1D::Types::Unknown
                    )
                ...
                pyNsGedim_ClassRefinementUtilities_ClassRefinePolyhedron_Result_ClassRefinedCell2D
                    ...
                    , py::arg("type") = RefinedCell2D::Types::Unknown
                    )
            ...
            pyNsGedim_ClassRefinementUtilities_ClassRefinePolyhedron_Result
                .def(py::init<>([](
                ResultTypes ResultType = ResultTypes::Unknown, std::vector<RefinedCell1D> NewCell1DsIndex = {}, std::vector<RefinedCell2D> NewCell2DsIndex = {})
                {
                ...
                , py::arg("result_type") = RefinePolyhedron_Result::ResultTypes::Unknown, py::arg("new_cell1_ds_index") = std::vector<RefinedCell1D>{}, py::arg("new_cell2_ds_index") = std::vector<RefinedCell2D>{}
                )
            ...
            pyNsGedim_ClassRefinementUtilities_ClassRefinePolygon_Result
                .def(py::init<>([](
                std::vector<RefinedCell1D> NewCell1DsIndex = {}, CheckSplitType_Result::SplitTypes SplitType = CheckSplitType_Result::SplitTypes::Unknown, ResultTypes ResultType = ResultTypes::Unknown)
                {
                ...
                , py::arg("new_cell1_ds_index") = std::vector<RefinedCell1D>{}, py::arg("split_type") = CheckSplitType_Result::SplitTypes::Unknown, py::arg("result_type") = RefinePolygon_Result::ResultTypes::Unknown
                )
            ...
            pyNsGedim_ClassRefinementUtilities_ClassRefinePolygon_UpdateNeighbour_Result
                ...
                , py::arg("updated_cell2_ds") = std::vector<UpdatedCell2D>{}
                )
            ...
            pyNsGedim_ClassRefinementUtilities_ClassRefinePolyhedron_UpdateNeighbour_Result
                ...
                , py::arg("updated_cell3_ds") = std::vector<UpdatedCell3D>{}
                )
            ...
            pyNsGedim_ClassRefinementUtilities_ClassCell2Ds_GeometricData
                .def(py::init<>([](
                Cell1D_GeometricData Cell1Ds = Cell1D_GeometricData(), Cell2D_GeometricData Cell2Ds = Cell2D_GeometricData())
                {
                ...
                , py::arg("cell1_ds") = Cell1D_GeometricData(), py::arg("cell2_ds") = Cell2D_GeometricData()
                )
    ...
    { // <namespace Gedim>
        py::module_ pyNsGedim = m.def_submodule("gedim", "namespace Gedim");
        auto pyNsGedim_ClassUnionMeshSegment =
            py::class_<Gedim::UnionMeshSegment>
                (pyNsGedim, "UnionMeshSegment", py::is_final(), "\n(final class)");

        { // inner classes & enums of UnionMeshSegment
            auto pyNsGedim_ClassUnionMeshSegment_ClassUnionMesh =
                py::class_<Gedim::UnionMeshSegment::UnionMesh>
                    (pyNsGedim_ClassUnionMeshSegment, "UnionMesh", py::is_final(), "\n(final class)");

            { // inner classes & enums of UnionMesh
                auto pyNsGedim_ClassUnionMeshSegment_ClassUnionMesh_ClassUnionMeshPoint =
                    py::class_<Gedim::UnionMeshSegment::UnionMesh::UnionMeshPoint>
                        (pyNsGedim_ClassUnionMeshSegment_ClassUnionMesh, "UnionMeshPoint", py::is_final(), "\n(final class)");

                { // inner classes & enums of UnionMeshPoint
                    auto pyEnumTypes =
                        py::enum_<Gedim::UnionMeshSegment::UnionMesh::UnionMeshPoint::Types>(pyNsGedim_ClassUnionMeshSegment_ClassUnionMesh_ClassUnionMeshPoint, "Types", py::arithmetic(), "")
                            .value("unknown", Gedim::UnionMeshSegment::UnionMesh::UnionMeshPoint::Types::Unknown, "")
                            .value("first", Gedim::UnionMeshSegment::UnionMesh::UnionMeshPoint::Types::First, "")
                            .value("second", Gedim::UnionMeshSegment::UnionMesh::UnionMeshPoint::Types::Second, "")
                            .value("both", Gedim::UnionMeshSegment::UnionMesh::UnionMeshPoint::Types::Both, "");
                } // end of inner classes & enums of UnionMeshPoint

                pyNsGedim_ClassUnionMeshSegment_ClassUnionMesh_ClassUnionMeshPoint
                    .def(py::init<>([](
                    Types Type = Types::Unknown)
                    {
                        auto r_ctor_ = std::make_unique<Gedim::UnionMeshSegment::UnionMesh::UnionMeshPoint>();
                        r_ctor_->Type = Type;
                        return r_ctor_;
                    })
                    , py::arg("type") = UnionMeshPoint::Types::Unknown
                    )
                    .def_readwrite("type", &Gedim::UnionMeshSegment::UnionMesh::UnionMeshPoint::Type, "")
                    .def_readwrite("mesh_indices", &Gedim::UnionMeshSegment::UnionMesh::UnionMeshPoint::MeshIndices, "/< vector of size 2 containing in each i the indices in mesh_i")
                    ;
                auto pyNsGedim_ClassUnionMeshSegment_ClassUnionMesh_ClassUnionMeshSegment =
                    py::class_<Gedim::UnionMeshSegment::UnionMesh::UnionMeshSegment>
                        (pyNsGedim_ClassUnionMeshSegment_ClassUnionMesh, "UnionMeshSegment", py::is_final(), "\n(final class)");

                { // inner classes & enums of UnionMeshSegment
                    auto pyEnumTypes =
                        py::enum_<Gedim::UnionMeshSegment::UnionMesh::UnionMeshSegment::Types>(pyNsGedim_ClassUnionMeshSegment_ClassUnionMesh_ClassUnionMeshSegment, "Types", py::arithmetic(), "")
                            .value("unknown", Gedim::UnionMeshSegment::UnionMesh::UnionMeshSegment::Types::Unknown, "")
                            .value("first", Gedim::UnionMeshSegment::UnionMesh::UnionMeshSegment::Types::First, "")
                            .value("second", Gedim::UnionMeshSegment::UnionMesh::UnionMeshSegment::Types::Second, "")
                            .value("both", Gedim::UnionMeshSegment::UnionMesh::UnionMeshSegment::Types::Both, "");
                } // end of inner classes & enums of UnionMeshSegment

                pyNsGedim_ClassUnionMeshSegment_ClassUnionMesh_ClassUnionMeshSegment
                    .def(py::init<>([](
                    Types Type = Types::Unknown, std::vector<double> Points = {})
                    {
                        auto r_ctor_ = std::make_unique<Gedim::UnionMeshSegment::UnionMesh::UnionMeshSegment>();
                        r_ctor_->Type = Type;
                        r_ctor_->Points = Points;
                        return r_ctor_;
                    })
                    , py::arg("type") = UnionMeshSegment::Types::Unknown, py::arg("points") = std::vector<double>{}
                    )
                    .def_readwrite("type", &Gedim::UnionMeshSegment::UnionMesh::UnionMeshSegment::Type, "")
                    .def_readwrite("points", &Gedim::UnionMeshSegment::UnionMesh::UnionMeshSegment::Points, "")
                    .def_readwrite("mesh_indices", &Gedim::UnionMeshSegment::UnionMesh::UnionMeshSegment::MeshIndices, "/< vector of size 2 containing in each i the indices in mesh_i")
                    ;
            } // end of inner classes & enums of UnionMesh

            pyNsGedim_ClassUnionMeshSegment_ClassUnionMesh
                .def(py::init<>([](
                std::vector<UnionMeshSegment> Segments = {})
                {
                    auto r_ctor_ = std::make_unique<Gedim::UnionMeshSegment::UnionMesh>();
                    r_ctor_->Segments = Segments;
                    return r_ctor_;
                })
                , py::arg("segments") = std::vector<UnionMeshSegment>{}
                )
                .def_readwrite("points", &Gedim::UnionMeshSegment::UnionMesh::Points, "")
                .def_readwrite("segments", &Gedim::UnionMeshSegment::UnionMesh::Segments, "")
                ;
        } // end of inner classes & enums of UnionMeshSegment

        pyNsGedim_ClassUnionMeshSegment
            .def_static("to_curvilinear_coordinates",
                &Gedim::UnionMeshSegment::ToCurvilinearCoordinates,
                py::arg("union_mesh"), py::arg("curvilinear_coordinates"),
                "/ \\brief convert UnionMesh to Curvilinear Coordinates vector")
            .def_static("to_string",
                &Gedim::UnionMeshSegment::ToString, py::arg("union_mesh"))
            .def(py::init<const Gedim::GeometryUtilities &>(),
                py::arg("geometry_utilities"))
            .def("create_union_mesh",
                &Gedim::UnionMeshSegment::CreateUnionMesh, py::arg("curvilinear_coordinates_mesh_one"), py::arg("curvilinear_coordinates_mesh_two"), py::arg("result"))
            ;
    } // </namespace Gedim>
    ////////////////////    </generated_from:UnionMeshSegment.hpp>    ////////////////////
    ...
    m.def("generate_voronoi_tassellations2_d",
        GenerateVoronoiTassellations2D, py::arg("polygon_vertices"), py::arg("num_iterations"), py::arg("voronoi_points"), py::arg("mesh"));

    m.def("generate_cartesian_points3_d",
        GenerateCartesianPoints3D, py::arg("polyhedron_vertices"), py::arg("num_points"), py::arg("con"));

    m.def("generate_random_points",
        GenerateRandomPoints, py::arg("domain_vertices"), py::arg("num_points"), py::arg("voronoi_points"), py::arg("random_seed") = static_cast<unsigned int>(time(nullptr));
    // #endif
    // };
    //
    // #endif
    ...
    { // <namespace Gedim>
        ...
        { // inner classes & enums of VoroInterface
            auto pyNsGedim_ClassVoroInterface_ClassCell0D =
                ...
                .def_readonly("x", &Gedim::VoroInterface::Cell0D::x, "")
                .def_readonly("y", &Gedim::VoroInterface::Cell0D::y, "")
                .def_readonly("z", &Gedim::VoroInterface::Cell0D::z, "")
                .def_readwrite("id", &Gedim::VoroInterface::Cell0D::id, "")
            ...
            auto pyNsGedim_ClassVoroInterface_ClassCell2D =
                ...
                .def_readwrite("id", &Gedim::VoroInterface::Cell2D::id, "")
        ...
        pyNsGedim_ClassVoroInterface
            ...
            .def("generate_voronoi_tassellations3_d",
                &Gedim::VoroInterface::GenerateVoronoiTassellations3D, py::arg("polyhedron_vertices"), py::arg("polyhedron_edges"), py::arg("polyhedron_faces"), py::arg("num_points"), py::arg("num_iterations"), py::arg("mesh"), py::arg("random_seed") = static_cast<unsigned int>(time(nullptr))
            ;


        pyNsGedim.def("generate_voronoi_tassellations2_d",
            Gedim::GenerateVoronoiTassellations2D, py::arg("polygon_vertices"), py::arg("num_points"), py::arg("num_iterations"), py::arg("mesh"), py::arg("random_seed") = static_cast<unsigned int>(time(nullptr));
    } // </namespace Gedim>
    ////////////////////    </generated_from:VoroInterface.hpp>    ////////////////////
    ...
    { // <namespace Gedim>
        py::module_ pyNsGedim = m.def_submodule("gedim", "namespace Gedim");
        auto pyNsGedim_ClassVtkMeshInterface =
            py::class_<Gedim::VtkMeshInterface>
                (pyNsGedim, "VtkMeshInterface", py::is_final(), "\n(final class)");

        { // inner classes & enums of VtkMeshInterface
            auto pyNsGedim_ClassVtkMeshInterface_ClassVtkMesh =
                py::class_<Gedim::VtkMeshInterface::VtkMesh>
                    (pyNsGedim_ClassVtkMeshInterface, "VtkMesh", py::is_final(), "\n(final class)");

            { // inner classes & enums of VtkMesh
                auto pyNsGedim_ClassVtkMeshInterface_ClassVtkMesh_ClassCell3D =
                    py::class_<Gedim::VtkMeshInterface::VtkMesh::Cell3D>
                        (pyNsGedim_ClassVtkMeshInterface_ClassVtkMesh, "Cell3D", py::is_final(), "\n(final class)");

                { // inner classes & enums of Cell3D
                    auto pyEnumTypes =
                        py::enum_<Gedim::VtkMeshInterface::VtkMesh::Cell3D::Types>(pyNsGedim_ClassVtkMeshInterface_ClassVtkMesh_ClassCell3D, "Types", py::arithmetic(), "")
                            .value("unknown", Gedim::VtkMeshInterface::VtkMesh::Cell3D::Types::Unknown, "")
                            .value("tetrahedron", Gedim::VtkMeshInterface::VtkMesh::Cell3D::Types::Tetrahedron, "")
                            .value("hexahedron", Gedim::VtkMeshInterface::VtkMesh::Cell3D::Types::Hexahedron, "");
                } // end of inner classes & enums of Cell3D

                pyNsGedim_ClassVtkMeshInterface_ClassVtkMesh_ClassCell3D
                    .def(py::init<>([](
                    Types Type = Types())
                    {
                        auto r_ctor_ = std::make_unique<Gedim::VtkMeshInterface::VtkMesh::Cell3D>();
                        r_ctor_->Type = Type;
                        return r_ctor_;
                    })
                    , py::arg("type") = Types()
                    )
                    .def_readwrite("cell0_d_id", &Gedim::VtkMeshInterface::VtkMesh::Cell3D::Cell0D_Id, "")
                    .def_readwrite("type", &Gedim::VtkMeshInterface::VtkMesh::Cell3D::Type, "")
                    ;
            } // end of inner classes & enums of VtkMesh

            pyNsGedim_ClassVtkMeshInterface_ClassVtkMesh
                .def(py::init<>([](
                Eigen::MatrixXd Cell0Ds = Eigen::MatrixXd(), std::vector<Cell3D> Cell3Ds = std::vector<Cell3D>())
                {
                    auto r_ctor_ = std::make_unique<Gedim::VtkMeshInterface::VtkMesh>();
                    r_ctor_->Cell0Ds = Cell0Ds;
                    r_ctor_->Cell3Ds = Cell3Ds;
                    return r_ctor_;
                })
                , py::arg("cell0_ds") = Eigen::MatrixXd(), py::arg("cell3_ds") = std::vector<Cell3D>()
                )
                .def_readwrite("num_cell0_ds", &Gedim::VtkMeshInterface::VtkMesh::NumCell0Ds, "")
                .def_readwrite("num_cell3_ds", &Gedim::VtkMeshInterface::VtkMesh::NumCell3Ds, "")
                .def_readwrite("cell0_ds", &Gedim::VtkMeshInterface::VtkMesh::Cell0Ds, "")
                .def_readwrite("cell3_ds", &Gedim::VtkMeshInterface::VtkMesh::Cell3Ds, "")
                ;
            auto pyNsGedim_ClassVtkMeshInterface_ClassVtkMesh3D =
                py::class_<Gedim::VtkMeshInterface::VtkMesh3D>
                    (pyNsGedim_ClassVtkMeshInterface, "VtkMesh3D", py::is_final(), "\n(final class)")
                .def(py::init<>([](
                Eigen::MatrixXd Cell0Ds = Eigen::MatrixXd(), Eigen::MatrixXi Cell1Ds = Eigen::MatrixXi(), std::vector<Eigen::MatrixXi> Cell2Ds = std::vector<Eigen::MatrixXi>(), std::vector<Gedim::MeshUtilities::Mesh3DPolyhedron> Cell3Ds = std::vector<Gedim::MeshUtilities::Mesh3DPolyhedron>())
                {
                    auto r_ctor_ = std::make_unique<Gedim::VtkMeshInterface::VtkMesh3D>();
                    r_ctor_->Cell0Ds = Cell0Ds;
                    r_ctor_->Cell1Ds = Cell1Ds;
                    r_ctor_->Cell2Ds = Cell2Ds;
                    r_ctor_->Cell3Ds = Cell3Ds;
                ...
                , py::arg("cell0_ds") = Eigen::MatrixXd(), py::arg("cell1_ds") = Eigen::MatrixXi(), py::arg("cell2_ds") = std::vector<Eigen::MatrixXi>(), py::arg("cell3_ds") = std::vector<Gedim::MeshUtilities::Mesh3DPolyhedron>()
                )
                .def_readwrite("markers", &Gedim::VtkMeshInterface::VtkMesh3D::Markers, "")
                .def_readwrite("cell0_ds", &Gedim::VtkMeshInterface::VtkMesh3D::Cell0Ds, "")
                .def_readwrite("cell1_ds", &Gedim::VtkMeshInterface::VtkMesh3D::Cell1Ds, "")
                .def_readwrite("cell2_ds", &Gedim::VtkMeshInterface::VtkMesh3D::Cell2Ds, "")
                .def_readwrite("cell3_ds", &Gedim::VtkMeshInterface::VtkMesh3D::Cell3Ds, "")
                ;
        } // end of inner classes & enums of VtkMeshInterface

        pyNsGedim_ClassVtkMeshInterface
            .def(py::init<>())
            .def("import_mesh3_d_from_file",
                &Gedim::VtkMeshInterface::ImportMesh3DFromFile, py::arg("vtk_file_path"))
            ;
    } // </namespace Gedim>
    ////////////////////    </generated_from:VtkMeshInterface.hpp>    ////////////////////
